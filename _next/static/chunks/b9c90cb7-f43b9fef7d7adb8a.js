...
`,eF=z.iv`
  ...
  ${e_.ensDark}
  ${e_.graphicsDark}
`,eW="auto",eT=ej(F.E.div)`
  ${eA.default}

  ${e=>{switch(e.$useTheme){case"web95":return eW="light",eA.web95;case"retro":return eW="light",eA.retro;case"soft":return eW="light",eA.soft;case"midnight":return eW="dark",eA.midnight;case"minimal":return eW="light",eA.minimal;case"rounded":return eW="light",eA.rounded;case"nouns":return eW="light",eA.nouns;default:if("light"===e.$useMode)return eW="light",eA.light;if("dark"===e.$useMode)return eW="dark",eA.dark;return z.iv`
  ...
  ${e=>{switch(eW){case"light":return eO;case"dark":return eF;default:return z.iv`
          ${eO}
          @media (prefers-color-scheme: dark) {
            ${eF}
          }
...
`,ez=e=>{let{selector:n,children:t}=e={selector:"__CONNECTKIT__",...e},o=(0,A.useRef)(null),[i,r]=(0,A.useState)(!1);return((0,A.useEffect)(()=>{let e="#"+n.replace(/^#/,"");if(o.current=document.querySelector(e),!o.current){let e=document.createElement("div");e.setAttribute("id",n),e.setAttribute("data-connectkit",`${rB}`),document.body.appendChild(e),o.current=e}r(!0)},[n]),o.current&&i)?(0,D.createPortal)(t,o.current):null};var eD={mobileWidth:560};let eR=ej(F.E.div)`
  z-index: -1;
  pointer-events: auto;
  position: absolute;
  left: 50%;
...
`;let e$=ej(F.E.div)`
  ...
  opacity: 0;
  animation: ${e=>e.$active?eB:eZ} 150ms ease-out
    both;
`,e1=z.F4`
...
Vui l\xf2ng thử lại.`,injectionScreen_notconnected_h1:`Đăng nhập v\xe0o {{ CONNECTORNAME }}`,injectionScreen_notconnected_p:`Để tiếp tục, vui l\xf2ng đăng nhập bằng tiện \xedch {{ CONNECTORNAME }}.`,profileScreen_heading:"Đ\xe3 kết nối",switchNetworkScreen_heading:"Đổi mạng",signInWithEthereumScreen_tooltip:"Bạn chưa đăng nhập v\xe0o ứng dụng.\n**Đăng nhập qua Ethereum** để tiếp tục.",signInWithEthereumScreen_signedOut_heading:"Đăng nhập qua Ethereum",signInWithEthereumScreen_signedOut_h1:"Ứng dụng n\xe0y muốn x\xe1c nhận bạn \n l\xe0 chủ sở hữu của v\xed.",signInWithEthereumScreen_signedOut_p:`Vui l\xf2ng k\xfd tin nhắn y\xeau cầu 
 ...
 x\xe1c nhận lại trong l\xe0n tiếp theo.`,signInWithEthereumScreen_signedIn_button:"Đăng xuất"},nD=e=>{switch(e){case"ee-EE":return nN;case"ar-AE":return nS;case"es-ES":return nL;case"fa-IR":return nM;case"fr-FR":return nI;case"ja-JP":return nA;case"pt-BR":return n_;case"ru-RU":return nO;case"zh-CN":return nF;case"ca-AD":return nW;case"tr-TR":return nT;case"vi-VN":return nz;default:return nE}};function nR(e){var n,t;let o=null!==(t=null===(n=rC().options)||void 0===n?void 0:n.language)&&void 0!==t?t:"en-US",i=(0,A.useMemo)(()=>nD(o),[o]);if(!i)return console.error(`Missing translations for: ${o}`),`Missing translations for: ${o}`;let r={};return Object.keys(i).map(n=>{let t=i[n];return r[n]=nB(t,e)}),r}let nB=(e,n)=>{let t=e;return n&&Object.keys(n).forEach(e=>{t=t.replace(RegExp(`({{ ${e} }})`,"g"),n[e])}),nH(t)},nH=e=>{let n=e;return n=(n=n.split("\n")).map((e,t)=>(0,I.jsxs)(A.Fragment,{children:[nU(e),t<n.length-1&&(0,I.jsx)("br",{})]},t))},nU=e=>e.split(/(\*\*[^\*]*\*\*)/g).map((e,n)=>/(\*\*.*\*\*)/g.test(e)?(0,I.jsx)("strong",{children:e.replace(/\*\*/g,"")},n):`${e}`).map(e=>"string"==typeof e?e.split(/(\[WALLETCONNECTLOGO\])/g).map(e=>"[WALLETCONNECTLOGO]"===e?(0,I.jsx)("span",{className:"ck-tt-logo",children:(0,I.jsx)(ea.WalletConnect,{})},e):e):e),nZ={debug:10,info:20,warn:30,error:40,none:100},nG="undefined"!=typeof window&&window.document&&void 0!==window.document.createElement?A.useLayoutEffect:A.useEffect,nV=({logLevel:e="info",maxFontSize:n=100,minFontSize:t=20,onFinish:o,onStart:i,resolution:r=5}={})=>{let a=nZ[e],c=(0,A.useCallback)(()=>({calcKey:0,fontSize:n,fontSizePrev:t,fontSizeMax:n,fontSizeMin:t}),[n,t]),s=(0,A.useRef)(null),d=(0,A.useRef)(),l=(0,A.useRef)(!1),[p,h]=(0,A.useState)(c),{calcKey:u,fontSize:g,fontSizeMax:x,fontSizeMin:b,fontSizePrev:m}=p,C=null,[v]=(0,A.useState)(()=>new U.Z(()=>{C=window.requestAnimationFrame(()=>{l.current||(i&&i(),l.current=!0,h({...c(),calcKey:u+1}))})}));(0,A.useEffect)(()=>(s.current&&v.observe(s.current),()=>{C&&window.cancelAnimationFrame(C),v.disconnect()}),[C,v]);let f=s.current&&s.current.innerHTML;return(0,A.useEffect)(()=>{0===u||l.current||(f!==d.current&&(i&&i(),h({...c(),calcKey:u+1})),d.current=f)},[u,c,f,i]),nG(()=>{let e;if(0===u)return;let n=Math.abs(g-m)<=r,i=!!s.current&&(s.current.scrollHeight>s.current.offsetHeight||s.current.scrollWidth>s.current.offsetWidth),c=i&&g===m,d=g>m;if(n){c?(l.current=!1,a<=nZ.info&&console.info(`[use-fit-text] reached \`minFontSize = ${t}\` without fitting text`)):i?h({fontSize:d?m:b,fontSizeMax:x,fontSizeMin:b,fontSizePrev:m,calcKey:u}):(l.current=!1,o&&o(g));return}let p=x,C=b;i?(e=d?m-g:b-g,p=Math.min(x,g)):(e=d?x-g:m-g,C=Math.max(b,g)),h({calcKey:u,fontSize:g+e/2,fontSizeMax:p,fontSizeMin:C,fontSizePrev:g})},[u,g,x,b,m,o,s,r]),{fontSize:g,ref:s}},nY=({children:e})=>{let[n,t]=A.useState(!1),{fontSize:o,ref:i}=nV({logLevel:"none",maxFontSize:100,minFontSize:70,onStart:()=>t(!0),onFinish:()=>t(!0)});return(0,I.jsx)("div",{ref:i,style:{visibility:n?"visible":"hidden",fontSize:`${o}%`,maxHeight:"100%",maxWidth:"100%",display:"flex",justifyContent:"center",alignItems:"center"},children:e})};function nP(){let e=(0,s.Y)();return null!=e?e:[]}function nQ(e,n){let t=nP();return"injected"===e&&n?t.find(t=>t.id===e&&t.name===n):"injected"===e?t.find(n=>n.id===e&&n.name.includes("Injected")):t.find(n=>n.id===e)}nY.displayName="FitText";let nX=e=>nJ().find(n=>n.id===e)||null,nJ=()=>{let e=nP(),n=rC();return e.map(e=>{var n,t;let o=Object.keys(ek).find(n=>-1!==n.split(",").map(e=>e.trim()).indexOf(e.id)),i={id:e.id,name:null!==(t=null!==(n=e.name)&&void 0!==n?n:e.id)&&void 0!==t?t:e.type,icon:(0,I.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}),connector:e,iconShape:"squircle",isInstalled:"mock"===e.type||"injected"===e.type&&"metaMask"!==e.id||eC(e.id)};if(o){let n=ek[o];return{...i,iconConnector:e.icon?(0,I.jsx)("img",{src:e.icon,alt:e.name,width:"100%",height:"100%"}):void 0,...n}}return i}).filter((e,n,t)=>t.findIndex(n=>n.id===e.id)===n).map(e=>{var t,o;return"walletConnect"===e.id?{...e,name:(null===(t=n.options)||void 0===t?void 0:t.walletConnectName)||e.name,shortName:(null===(o=n.options)||void 0===o?void 0:o.walletConnectName)||e.shortName}:e}).filter((e,n,t)=>!("coinbaseWalletSDK"===e.id&&t.find(e=>"com.coinbase.wallet"===e.id))).filter((e,n,t)=>!(("metaMaskSDK"===e.id||"metaMask"===e.id)&&t.find(e=>"io.metamask"===e.id||"io.metamask.mobile"===e.id))).sort((e,n)=>{let t=e.isInstalled&&ef(e.connector.type),o=n.isInstalled&&ef(n.connector.type);return t&&!o?-1:!t&&o?1:0}).sort((e,n)=>"walletConnect"===e.id?1:"walletConnect"===n.id?-1:0)},nq=({isSignedIn:e})=>(0,I.jsxs)("div",{style:{position:"relative"},children:[e?(0,I.jsx)(nw,{style:{bottom:-1,right:-1}}):(0,I.jsx)("div",{style:{zIndex:2,position:"absolute",top:-2,right:-2,background:"#1A88F8",borderRadius:8,boxShadow:"0 0 0 2px var(--ck-body-background)",width:8,height:8}}),(0,I.jsxs)("svg",{"aria-hidden":"true",width:"20",height:"20",viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",style:{overflow:"visible"},children:[(0,I.jsx)("circle",{cx:"10",cy:"10",r:"9",stroke:"currentColor",strokeWidth:"2"}),(0,I.jsx)("path",{d:"M16.5 16.775C14.8618 15.0649 12.5552 14 10 14C7.44477 14 5.13825 15.0649 3.5 16.775",stroke:"currentColor",strokeWidth:"2"}),(0,I.jsx)("circle",{cx:"10",cy:"8",r:"3",stroke:"currentColor",strokeWidth:"2"})]})]}),nK=({...e})=>(0,I.jsx)("svg",{"aria-hidden":"true",width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,I.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M20 11C20 15.9706 15.9706 20 11 20C6.02944 20 2 15.9706 2 11C2 6.02944 6.02944 2 11 2C15.9706 2 20 6.02944 20 11ZM22 11C22 17.0751 17.0751 22 11 22C4.92487 22 0 17.0751 0 11C0 4.92487 4.92487 0 11 0C17.0751 0 22 4.92487 22 11ZM11.6445 12.7051C11.6445 13.1348 11.3223 13.4678 10.7744 13.4678C10.2266 13.4678 9.92578 13.1885 9.92578 12.6191V12.4795C9.92578 11.4268 10.4951 10.8574 11.2686 10.3203C12.2031 9.67578 12.665 9.32129 12.665 8.59082C12.665 7.76367 12.0205 7.21582 11.043 7.21582C10.3232 7.21582 9.80762 7.57031 9.45312 8.16113C9.38282 8.24242 9.32286 8.32101 9.2667 8.39461C9.04826 8.68087 8.88747 8.8916 8.40039 8.8916C8.0459 8.8916 7.66992 8.62305 7.66992 8.15039C7.66992 7.96777 7.70215 7.7959 7.75586 7.61328C8.05664 6.625 9.27051 5.75488 11.1182 5.75488C12.9336 5.75488 14.5234 6.71094 14.5234 8.50488C14.5234 9.7832 13.7822 10.417 12.7402 11.1045C11.999 11.5986 11.6445 11.9746 11.6445 12.5762V12.7051ZM11.9131 15.5625C11.9131 16.1855 11.376 16.6797 10.7529 16.6797C10.1299 16.6797 9.59277 16.1748 9.59277 15.5625C9.59277 14.9395 10.1191 14.4453 10.7529 14.4453C11.3867 14.4453 11.9131 14.9287 11.9131 15.5625Z",fill:"currentColor"})}),n$=({...e})=>(0,I.jsx)(F.E.svg,{width:14,height:14,viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,I.jsx)("path",{d:"M1 13L13 1M1 1L13 13",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round"})}),n1=({...e})=>(0,I.jsx)(F.E.svg,{width:9,height:16,viewBox:"0 0 9 16",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,I.jsx)("path",{d:"M8 1L1 8L8 15",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),n0={initial:{zIndex:2,opacity:0},animate:{opacity:1,scale:1,transition:{duration:.165,delay:.055,ease:[.26,.08,.25,1]}},exit:{zIndex:1,opacity:0,pointerEvents:"none",position:"absolute",left:["50%","50%"],x:["-50%","-50%"],transition:{duration:.22,ease:[.26,.08,.25,1]}}},n2=({open:e,pages:n,pageId:t,positionInside:o,inline:i,demo:r,onClose:a,onBack:c,onInfo:s})=>{var p,h,u,g,x,b,m,C,v,f,k,w;let y;let j=rC(),S=ng(),E=ex(),{isSignedIn:N,reset:L}=nj(),M=nX(null===(p=j.connector)||void 0===p?void 0:p.id),_={name:null==M?void 0:M.name,shortName:null!==(h=null==M?void 0:M.shortName)&&void 0!==h?h:null==M?void 0:M.name,icon:null!==(u=null==M?void 0:M.iconConnector)&&void 0!==u?u:null==M?void 0:M.icon,iconShape:null!==(g=null==M?void 0:M.iconShape)&&void 0!==g?g:"circle",iconShouldShrink:null==M?void 0:M.iconShouldShrink},O=nR({CONNECTORNAME:null==_?void 0:_.name}),[T,z]=(0,G.Y)({timeout:160,preEnter:!0,mountOnEnter:!0,unmountOnExit:!0}),D=!("exited"===T||"unmounted"===T),R="preEnter"===T||"exiting"!==T,B=j.route===rx.CONNECTORS?0:j.route===rx.DOWNLOAD?2:1,H=np(B,B);o||nd(D),np(t,t),(0,A.useEffect)(()=>{z(e),e&&Y(void 0)},[e]);let[U,Z]=(0,A.useState)({width:void 0,height:void 0}),[V,Y]=(0,A.useState)(void 0),P=e=>{let n={width:null==e?void 0:e.offsetWidth,height:null==e?void 0:e.offsetHeight};Z({width:`${null==n?void 0:n.width}px`,height:`${null==n?void 0:n.height}px`})},Q=(0,A.useCallback)(e=>{e&&(q.current=e,Y(void 0!==V),clearTimeout(y),y=setTimeout(()=>Y(!1),360),P(e))},[e,V]),{chain:X}=(0,d.m)(),{switchChain:J}=(0,l.o)(),q=(0,A.useRef)(null);(0,A.useEffect)(()=>{q.current&&P(q.current)},[X,J,E,N,j.options,j.resize]),(0,A.useEffect)(()=>{if(!D){Z({width:void 0,height:void 0});return}let e=e=>{"Escape"===e.key&&a&&a()};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[D,a]);let K={"--height":U.height,"--width":U.width},$=(0,I.jsx)(eT,{$useTheme:null!==(x=null==r?void 0:r.theme)&&void 0!==x?x:S.theme,$useMode:null!==(b=null==r?void 0:r.mode)&&void 0!==b?b:S.mode,$customTheme:null!==(m=null==r?void 0:r.customTheme)&&void 0!==m?m:S.customTheme,children:(0,I.jsxs)(e7,{role:"dialog",style:{pointerEvents:R?"auto":"none",position:o?"absolute":void 0},children:[!i&&(0,I.jsx)(e$,{$active:R,onClick:a,$blur:null===(C=j.options)||void 0===C?void 0:C.overlayBlur}),(0,I.jsxs)(ni,{style:K,initial:!1,children:[(0,I.jsx)("div",{style:{pointerEvents:V?"all":"none",position:"absolute",top:0,bottom:0,left:"50%",transform:"translateX(-50%)",width:"var(--width)",zIndex:9,transition:"width 200ms ease"}}),(0,I.jsxs)(e5,{className:`${R&&"active"}`,children:[(0,I.jsx)(W.M,{initial:!1,children:(null===(v=j.options)||void 0===v?void 0:v.disclaimer)&&j.route===rx.CONNECTORS&&(0,I.jsx)(na,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{delay:0,duration:.2,ease:[.25,.1,.25,1]},children:(0,I.jsx)(nr,{children:(0,I.jsx)("div",{children:null===(f=j.options)||void 0===f?void 0:f.disclaimer})})})}),(0,I.jsx)(W.M,{initial:!1,children:j.errorMessage&&(0,I.jsxs)(eR,{initial:{y:"10%",x:"-50%"},animate:{y:"-100%"},exit:{y:"100%"},transition:{duration:.2,ease:"easeInOut"},children:[(0,I.jsx)("span",{children:j.errorMessage}),(0,I.jsx)("div",{onClick:()=>j.displayError(null),style:{position:"absolute",right:24,top:24,cursor:"pointer"},children:(0,I.jsx)(n$,{})})]})}),(0,I.jsxs)(e4,{children:[a&&(0,I.jsx)(ne,{"aria-label":eb(O.close).toString(),onClick:a,children:(0,I.jsx)(n$,{})}),(0,I.jsx)("div",{style:{position:"absolute",top:23,left:20,width:32,height:32},children:(0,I.jsx)(W.M,{children:c?(0,I.jsx)(nt,{disabled:V,"aria-label":eb(O.back).toString(),onClick:c,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,I.jsx)(n1,{})},"backButton"):j.route===rx.PROFILE&&j.signInWithEthereum?(0,I.jsxs)(I.Fragment,{children:[!N&&!(null===(k=j.options)||void 0===k?void 0:k.hideTooltips)&&(0,I.jsx)(F.E.div,{style:{position:"absolute",inset:0,pointerEvents:"none"},initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1,transition:{delay:.5,duration:.2}},exit:{opacity:0,scale:.6,transition:{delay:0,duration:E?0:.1}},children:(0,I.jsx)(nc,{children:O.signInWithEthereumScreen_tooltip})}),(0,I.jsx)(nn,{disabled:V,"aria-label":O.signInWithEthereumScreen_signedOut_heading,onClick:()=>{L(),j.setRoute(rx.SIGNINWITHETHEREUM)},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,I.jsx)(nq,{isSignedIn:N})},"siweButton")]}):s&&!(null===(w=j.options)||void 0===w?void 0:w.hideQuestionMarkCTA)&&(0,I.jsx)(no,{disabled:V,"aria-label":eb(O.moreInformation).toString(),onClick:s,initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.1,delay:E?.01:0},children:(0,I.jsx)(nK,{})},"infoButton")})})]}),(0,I.jsx)(eQ,{children:(0,I.jsx)(W.M,{children:(0,I.jsx)(F.E.div,{style:{position:"absolute",top:0,bottom:0,left:52,right:52,display:"flex",justifyContent:"center"},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:E?0:.17,delay:E?.01:0},children:(0,I.jsx)(nY,{children:function(){var e;switch(j.route){case rx.ABOUT:return O.aboutScreen_heading;case rx.CONNECT:if(M&&!(!M.getWalletConnectDeeplink||M.isInstalled))return em(null===(e=null==M?void 0:M.connector)||void 0===e?void 0:e.id)?O.scanScreen_heading:O.scanScreen_heading_withConnector;return null==_?void 0:_.name;case rx.CONNECTORS:return O.connectorsScreen_heading;case rx.MOBILECONNECTORS:return O.mobileConnectorsScreen_heading;case rx.DOWNLOAD:return O.downloadAppScreen_heading;case rx.ONBOARDING:return O.onboardingScreen_heading;case rx.PROFILE:return O.profileScreen_heading;case rx.SWITCHNETWORKS:return O.switchNetworkScreen_heading;case rx.SIGNINWITHETHEREUM:return N?O.signInWithEthereumScreen_signedIn_heading:O.signInWithEthereumScreen_signedOut_heading;default:return""}}()})},`${j.route}-${N?"signedIn":""}`)})}),(0,I.jsx)(e9,{children:Object.keys(n).map(e=>{let i=n[e];return(0,I.jsx)(n3,{open:e===t,initial:!o&&"entered"!==T,enterAnim:e===t?B>H?"active-scale-up":"active":"",exitAnim:e!==t?B<H?"exit-scale-down":"exit":"",children:(0,I.jsx)(e6,{ref:Q,style:{pointerEvents:e===t&&R?"auto":"none"},children:i},`inner-${e}`)},e)})})]})]})]})});return(0,I.jsx)(I.Fragment,{children:D&&(0,I.jsx)(I.Fragment,{children:o?$:(0,I.jsx)(I.Fragment,{children:(0,I.jsx)(ez,{children:(0,I.jsx)(nl,{children:$})})})})})},n3=({children:e,open:n,initial:t,prevDepth:o,currentDepth:i,enterAnim:r,exitAnim:a})=>{let[c,s]=(0,G.Y)({timeout:400,preEnter:!0,initialEntered:n,mountOnEnter:!0,unmountOnExit:!0});return((0,A.useEffect)(()=>{s(n)},[n]),"exited"===c||"unmounted"===c)?null:(0,I.jsx)(e8,{className:`${"preEnter"===c||"exiting"!==c?r:a}`,style:{animationDuration:t?"0ms":void 0,animationDelay:t?"0ms":void 0},children:e})},n5=({children:e})=>{let n=nR();return(0,I.jsx)(eP,{children:(0,I.jsx)("span",{children:null!=e?e:n.or})})},n4=ej(F.E.div)`
  position: relative;
...
`,n6=ej(F.E.div)`
  ...
  animation: ${n8} 1000ms 100ms ease both;
  @media only screen and (max-width: ${eD.mobileWidth}px) {
    animation: none;
  }
`,n7=z.F4`
...
`,tc=ej(F.E.div)`
  ...
  animation: ${n7} 750ms cubic-bezier(0.19, 1, 0.22, 1) both;
  ...
  &:nth-child(1){ ${ta}{ animation-delay:0ms; } }
  &:nth-child(2){ ${ta}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${ta}{ animation-delay:-1200ms; } }
  &:nth-child(4){ ${ta}{ animation-delay:-1800ms; } }
  &:nth-child(5){ ${ta}{ animation-delay:-2400ms; } }

  &:nth-child(1){ ${ti}{ animation-delay:-200ms; } }
  &:nth-child(2){ ${ti}{ animation-delay:-600ms; } }
  &:nth-child(3){ ${ti}{ animation-delay:-800ms; } }
  &:nth-child(4){ ${ti}{ animation-delay:-300ms; } }
  &:nth-child(5){ ${ti}{ animation-delay:-3200ms; } }
...
`,tk={duration:.4,ease:[.175,.885,.32,.98]},tw=()=>(0,I.jsx)(tf,{initial:{opacity:0,rotate:180},animate:{opacity:1,rotate:0},exit:{position:"absolute",opacity:0,rotate:-180,transition:{...tk}},transition:{...tk,delay:.2},children:(0,I.jsxs)("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)("circle",{cx:"9",cy:"9",r:"7",stroke:"currentColor",strokeOpacity:"0.1",strokeWidth:"2.5"}),(0,I.jsx)("path",{d:"M16 9C16 5.13401 12.866 2 9 2",stroke:"currentColor",strokeWidth:"2.5",strokeLinecap:"round"})]})}),ty={duration:.4,ease:[.175,.885,.32,.98]},tj=({children:e,variant:n="secondary",disabled:t,icon:o,iconPosition:i="left",roundedIcon:r,waiting:a,arrow:c,download:s,href:d,style:l,onClick:p})=>{let h="string"==typeof e?e:eb(e).join(""),u="string"==typeof d?d:eb(d).join("");return(0,I.jsx)(tb,{as:d?"a":void 0,onClick:e=>{!t&&p&&p(e)},href:u,target:d&&"_blank",rel:d&&"noopener noreferrer",disabled:t,$variant:n,style:l,children:(0,I.jsxs)(W.M,{initial:!1,children:[(0,I.jsxs)(tx,{initial:{opacity:0,y:-10},animate:{opacity:1,y:-1},exit:{position:"absolute",opacity:0,y:10,transition:{...ty}},transition:{...ty,delay:.2},children:[o&&"left"===i&&(0,I.jsx)(tC,{$rounded:r,children:o}),s&&(0,I.jsx)(tu,{children:(0,I.jsx)(tg,{children:(0,I.jsxs)(tl,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)(th,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"}),(0,I.jsx)(tp,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"var(--stroke-width)",strokeLinecap:"round"})]})})}),(0,I.jsx)(tm,{style:{paddingLeft:c?6:0},children:(0,I.jsx)(nY,{children:e})}),o&&"right"===i&&(0,I.jsx)(tC,{$rounded:r,children:o}),c&&(0,I.jsxs)(tl,{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)(th,{stroke:"currentColor",x1:"1",y1:"6",x2:"12",y2:"6",strokeWidth:"2",strokeLinecap:"round"}),(0,I.jsx)(tp,{stroke:"currentColor",d:"M7.51431 1.5L11.757 5.74264M7.5 10.4858L11.7426 6.24314",strokeWidth:"2",strokeLinecap:"round"})]})]},h),a&&(0,I.jsx)(td,{children:(0,I.jsx)(tw,{})})]})})},tS=()=>{var e,n;let t=rC(),o=nR({}),i=null!==(n=null===(e=t.options)||void 0===e?void 0:e.walletOnboardingUrl)&&void 0!==n?n:o.onboardingScreen_ctaUrl;return(0,I.jsxs)(eY,{children:[(0,I.jsxs)(n4,{children:[(0,I.jsxs)(n9,{children:[(0,I.jsx)(tc,{children:(0,I.jsx)(te,{children:(0,I.jsx)(tn,{children:(0,I.jsx)(ti,{children:(0,I.jsx)(ta,{children:(0,I.jsx)(tt,{children:(0,I.jsx)(ea.Coinbase,{background:!0})})})})})})}),(0,I.jsx)(tc,{children:(0,I.jsx)(te,{children:(0,I.jsx)(tn,{children:(0,I.jsx)(ti,{children:(0,I.jsx)(ta,{children:(0,I.jsx)(tt,{children:(0,I.jsx)(ea.MetaMask,{background:!0})})})})})})}),(0,I.jsx)(tc,{children:(0,I.jsx)(te,{children:(0,I.jsx)(tn,{children:(0,I.jsx)(ti,{children:(0,I.jsx)(ta,{children:(0,I.jsx)(tt,{children:(0,I.jsx)(ea.Trust,{})})})})})})}),(0,I.jsx)(tc,{children:(0,I.jsx)(te,{children:(0,I.jsx)(tn,{children:(0,I.jsx)(ti,{children:(0,I.jsx)(ta,{children:(0,I.jsx)(tt,{children:(0,I.jsx)(ea.Argent,{})})})})})})}),(0,I.jsx)(tc,{children:(0,I.jsx)(te,{children:(0,I.jsx)(tn,{children:(0,I.jsx)(ti,{children:(0,I.jsx)(ta,{children:(0,I.jsx)(tt,{children:(0,I.jsx)(ea.ImToken,{})})})})})})})]}),(0,I.jsx)(n6,{children:ts})]}),(0,I.jsxs)(eJ,{style:{paddingBottom:18},children:[(0,I.jsx)(eq,{$small:!0,children:o.onboardingScreen_h1}),(0,I.jsx)(eK,{children:o.onboardingScreen_p})]}),(0,I.jsx)(tj,{href:i,arrow:!0,children:o.onboardingScreen_ctaText})]})},tE=ej.div`
  pointer-events: none;
  user-select: none;
  height: ${208}px;
  padding: 0 0 12px;
...
`,tO=ej.button`
  ...
  ${e=>e.$active?z.iv`
        ...
        `}
`,tF={scale:[.9,1.25,1.6],opacity:[0,.11,0]},tW={ease:"linear",duration:2,repeat:1/0},tT=ej.div`
  position: absolute;
  left: 50%;
  top: 50%;
...
`,t9=ej(F.E.span)``,t8=ej(F.E.div)``,t6={desktop:{ConnectorButton:z.iv`
  ...
  &:after {
    ...
    animation: ${t5} 2s linear infinite;
  }
`,oe=ej.div`
  transition: opacity 300ms ease;
  min-width: fit-content;
  ...
  ${e=>e.$mobile?z.iv`
          ...
          ${t4} {
            flex-shrink: 0;
            width: 80px;
            ${t6.mobile.ConnectorButton}
            ${t9} {
              ${t6.mobile.ConnectorLabel}
              ${t7} {
                display: none;
                width: fit-content;
                margin: 0 auto;
        ...
        `:z.iv`
          ...
          ${t4} {
            ${t6.desktop.ConnectorButton}
            ${t9} {
              ${t6.desktop.ConnectorLabel}
            }
            ${t8} {
              ${t6.desktop.ConnectorIcon}
            }
          }
        `}
`;function on(){var e;let n=(0,p.Z)();return(null!==(e=null==n?void 0:n.chains)&&void 0!==e?e:[]).map(e=>e)}function ot({...e}={}){let n=rC(),{connect:t,connectAsync:o,connectors:i,...r}=(0,h.$)({...e,mutation:{...e.mutation,onError(e){e.message?"User rejected request"!==e.message&&n.log(e.message,e):n.log("Could not connect.",e)}}});return{connect:({connector:e,chainId:o,mutation:i})=>{var r;return t({connector:e,chainId:null!=o?o:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectAsync:async({connector:e,chainId:t,mutation:i})=>{var r;return o({connector:e,chainId:null!=t?t:null===(r=n.options)||void 0===r?void 0:r.initialChainId},i)},connectors:i,...r}}function oo(e){let{chains:n}=(0,p.Z)();return!!e&&n.some(n=>n.id===e)}let oi=A.createContext({connect:{getUri:()=>""},dapp:{chains:[]},account:void 0}),or=({enabled:e,children:n})=>{let{uri:t}=function({enabled:e}={enabled:!0}){let{log:n}=rC(),[t,o]=(0,A.useState)(void 0),i=nQ("walletConnect"),{isConnected:r}=(0,d.m)(),{connectAsync:a}=ot();return(0,A.useEffect)(()=>{if(e){if(r)o(void 0);else{if(!i||t)return;if(i&&!r)return l(i),n("add wc listeners"),i.emitter.on("message",c),i.emitter.on("disconnect",s),()=>{n("remove wc listeners"),i.emitter.off("message",c),i.emitter.off("disconnect",s)}}}async function c(e){let{type:t,data:i}=e;n("WC Message",t,i),"display_uri"===t&&o(i)}async function s(){n("WC Disconnect"),i&&d(i)}async function d(e){let n=await a({connector:e});return!!n&&n}async function l(e){try{await d(e)}catch(t){n("catch error"),n(t),t.code?4001===t.code?(n("error.code - User rejected"),l(e)):n("error.code - Unknown Error"):n("WalletConnect cannot connect.",t)}}},[e,i,r]),{uri:t}}({enabled:e}),{address:o,chain:i}=(0,d.m)(),r=oo(null==i?void 0:i.id),a=on();return(0,I.jsx)(oi.Provider,{value:{connect:{getUri:e=>t},dapp:{chains:a},account:o?{chain:i,chainIsSupported:r,address:o}:void 0},children:n})},oa=()=>A.useContext(oi);function oc(){let[e,n]=(0,A.useState)(ex());return(0,A.useEffect)(()=>{let e=()=>{n(ex())};return window.addEventListener("resize",e),()=>window.removeEventListener("resize",e)},[]),e}let os=ej.div`
  position: relative;
`,od=z.F4`
0%{ opacity:0; }
100%{ opacity:1; }
`,ol=ej.div`
  ...
  span {
    ...
    animation: ${od} 300ms ease 1000ms both;
...
`,op=ej.div`
  ...
  ${({$mobile:e,$height:n,$mobileDirection:t})=>e&&"horizontal"===t?z.iv`
          overflow-x: scroll;
          margin: 0 -24px;
          padding: 0 24px;
...
`,oh=()=>(0,I.jsx)("svg",{width:"11",height:"12",viewBox:"0 0 11 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,I.jsx)("path",{d:"M5.49438 1L5.49438 11M5.49438 11L9.5 7M5.49438 11L1.5 7",stroke:"currentColor",strokeWidth:"1.75",strokeLinecap:"round",strokeLinejoin:"round"})}),ou=({children:e,height:n,backgroundColor:t,mobileDirection:o})=>{let i=(0,A.useRef)(null),r=(0,A.useRef)(null),a=oc();return(0,A.useEffect)(()=>{let e=i.current;if(!e)return;e.scrollHeight>e.clientHeight&&r.current&&r.current.classList.remove("hide");let n=n=>{let{scrollTop:t,scrollHeight:o,clientHeight:i,scrollLeft:a,scrollWidth:c,clientWidth:s}=n.target;r.current&&t>0&&r.current.classList.add("hide"),0===t&&0===a?e.classList.add("scroll-start"):e.classList.remove("scroll-start"),o-t===i&&c-a===s?e.classList.add("scroll-end"):e.classList.remove("scroll-end")};return e.addEventListener("scroll",n),n({target:e}),()=>{e.removeEventListener("scroll",n)}},[i.current]),(0,I.jsxs)(os,{children:[(0,I.jsx)(op,{ref:i,$mobile:a,$height:n,$backgroundColor:t,$mobileDirection:o,children:e}),(0,I.jsx)(ol,{ref:r,className:"hide",onClick:()=>{i.current&&i.current.scrollTo({top:i.current.scrollHeight,behavior:"smooth"})},children:(0,I.jsxs)("span",{children:[(0,I.jsx)(oh,{})," More Available"]})})]})},og=ej(F.E.div)`
  display: flex;
  gap: 8px;
  position: relative;
  border-radius: 9px;
...
`,ob=({children:e,error:n,icon:t})=>(0,I.jsxs)(og,{$error:n,children:[t&&(0,I.jsx)(ox,{children:t}),(0,I.jsx)("div",{children:e})]});ob.displayName="Alert";let om=()=>{let{storage:e}=(0,p.Z)(),[n,t]=(0,A.useState)(null);return(0,A.useEffect)(()=>{(async()=>{let n=await (null==e?void 0:e.getItem("recentConnectorId"));t(null!=n?n:"")})()},[]),{lastConnectorId:n,updateLastConnectorId:n=>{null==e||e.setItem("recentConnectorId",n)}}},oC=()=>{var e;let n=rC(),t=oc(),o=nJ(),{lastConnectorId:i}=om(),r=(null===(e=n.options)||void 0===e?void 0:e.hideRecentBadge)||"walletConnect"===i?o:[...o.filter(e=>i===e.connector.id),...o.filter(e=>i!==e.connector.id)];return(0,I.jsxs)(ou,{mobileDirection:"horizontal",children:[0===r.length&&(0,I.jsx)(ob,{error:!0,children:"No connectors found in ConnectKit config."}),r.length>0&&(0,I.jsx)(oe,{$mobile:t,$totalResults:r.length,children:r.map(e=>(0,I.jsx)(ov,{wallet:e,isRecent:e.id===i},e.id))})]})},ov=({wallet:e,isRecent:n})=>{var t,o,i,r;let{connect:{getUri:a}}=oa(),c=a(),s=oc(),d=rC(),{connect:l}=ot(),p=!e.isInstalled&&s||e.shouldDeeplinkDesktop&&!s?null===(t=e.getWalletConnectDeeplink)||void 0===t?void 0:t.call(e,null!=c?c:""):void 0,h=s&&em(e.id),u=("safari"===ep()||"ios"===ep())&&eC(e.connector.id);return(h||u)&&(p=void 0),(0,I.jsxs)(t4,{type:"button",as:p?"a":void 0,href:p||void 0,disabled:d.route!==rx.CONNECTORS,onClick:p?void 0:()=>{h?d.setRoute(rx.MOBILECONNECTORS):(u&&l({connector:null==e?void 0:e.connector}),d.setRoute(rx.CONNECT),d.setConnector({id:e.id}))},children:[(0,I.jsx)(t8,{"data-small":e.iconShouldShrink,"data-shape":e.iconShape,children:null!==(o=e.iconConnector)&&void 0!==o?o:e.icon}),(0,I.jsxs)(t9,{children:[s&&null!==(i=e.shortName)&&void 0!==i?i:e.name,!(null===(r=d.options)||void 0===r?void 0:r.hideRecentBadge)&&n&&(0,I.jsx)(t7,{children:(0,I.jsx)("span",{children:"Recent"})})]})]})},of=()=>{var e,n,t,o,i;let r=rC(),a=nR({}),c=oc();return(0,I.jsxs)(eY,{style:{width:312},children:[(0,I.jsx)(oC,{}),c?(0,I.jsx)(I.Fragment,{children:(0,I.jsxs)(t$,{children:[(0,I.jsxs)(eJ,{style:{padding:0,textAlign:"left"},children:[(0,I.jsx)(eq,{$small:!0,children:a.connectorsScreen_h1}),(0,I.jsx)(eK,{children:a.connectorsScreen_p})]}),(0,I.jsxs)(t1,{children:[!(null===(e=r.options)||void 0===e?void 0:e.hideQuestionMarkCTA)&&(0,I.jsx)(tj,{variant:"tertiary",onClick:()=>r.setRoute(rx.ABOUT),children:a.learnMore}),!(null===(n=r.options)||void 0===n?void 0:n.hideNoWalletCTA)&&(0,I.jsx)(tj,{variant:"tertiary",onClick:()=>r.setRoute(rx.ONBOARDING),children:a.getWallet})]})]})}):(0,I.jsx)(I.Fragment,{children:!(null===(t=r.options)||void 0===t?void 0:t.hideNoWalletCTA)&&(0,I.jsx)(t0,{children:(0,I.jsxs)(t2,{onClick:()=>r.setRoute(rx.ONBOARDING),children:[(0,I.jsx)(t3,{})," ",a.connectorsScreen_newcomer]})})}),(null===(o=r.options)||void 0===o?void 0:o.disclaimer)&&(0,I.jsx)(nr,{style:{visibility:"hidden",pointerEvents:"none"},children:(0,I.jsx)("div",{children:null===(i=r.options)||void 0===i?void 0:i.disclaimer})})]})},ok=ej.div`
  text-align: center;
...
`,oS=ej.div`
  ...
  ${e=>e.$disabled&&z.iv`
      ...
      opacity: 0.4;
      ${ok} {
        animation: ${oj} 1s infinite ease-in-out;
      }
    `}
`,oE=ej.div``;function oN(){let{log:e}=rC(),{connectAsync:n,connectors:t}=ot(),[o,i]=(0,A.useState)(!1);return{isOpen:o,open:async()=>{let o=document.createElement("style");o.innerHTML="w3m-modal, wcm-modal{ --wcm-z-index: 2147483647; --w3m-z-index:2147483647; }",document.head.appendChild(o);let r=t.find(e=>em(e.id));if(r)try{let t=(await r.getProvider()).rpc.projectId,a=(0,M.a)({projectId:t,showQrModal:!0});i(!0);try{await n({connector:a})}catch(n){e("WalletConnect",n)}i(!1),document.head.removeChild(o)}catch(n){e("Could not get WalletConnect provider",n)}else e("No WalletConnect connector available")}}}let oL=ej(F.E.div)`
  ...
  ${e=>e.$clipboard?z.iv`
        ...
        `}
`,oM=({copied:e,small:n})=>(0,I.jsx)(oL,{$clipboard:e,children:(0,I.jsx)(nk,{style:{transform:n?"scale(1)":"translateX(3px) scale(1.5)",opacity:n||e?1:.3}})}),oI=ej.div`
...
`,o_=({string:e,children:n,variant:t})=>{let o;let[i,r]=(0,A.useState)(!1),a=()=>{if(!e)return;let n=e.trim();navigator.clipboard&&navigator.clipboard.writeText(n),r(!0),clearTimeout(o),o=setTimeout(()=>r(!1),1e3)};return"button"===t?(0,I.jsx)(tj,{disabled:!e,onClick:a,icon:(0,I.jsx)(oM,{copied:i}),children:n}):(0,I.jsx)(oI,{onClick:a,$disabled:!e,children:(0,I.jsxs)(oA,{children:[n,(0,I.jsx)(oM,{copied:i,small:!0})]})})},oO=(0,I.jsx)("svg",{width:"60",height:"60",viewBox:"0 0 60 60",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,I.jsx)("path",{d:"M30 42V19M19 30.5H42",stroke:"var(--ck-body-color-muted)",strokeWidth:"3",strokeLinecap:"round"})}),oF=()=>{var e,n;let t=rC(),o=nR(),{connect:{getUri:i}}=oa(),r=i(),{open:a,isOpen:c}=oN(),s=nJ(),d=null!==(e=Object.keys(ek).filter(e=>{let n=ek[e];return!s.find(n=>n.connector.id===e)&&!!n.getWalletConnectDeeplink}))&&void 0!==e?e:[],l=e=>{var n;let t=null===(n=e.getWalletConnectDeeplink)||void 0===n?void 0:n.call(e,r);t&&(window.location.href=t)};return(0,I.jsx)(eY,{style:{width:312},children:(0,I.jsxs)(oE,{children:[(0,I.jsx)(eJ,{style:{paddingBottom:0},children:(0,I.jsx)(ou,{height:340,children:(0,I.jsxs)(oS,{$disabled:!r,children:[d.sort((e,n)=>{var t,o,i,r;let a=ek[e],c=ek[n],s=null!==(o=null!==(t=a.name)&&void 0!==t?t:a.shortName)&&void 0!==o?o:e,d=null!==(r=null!==(i=c.name)&&void 0!==i?i:c.shortName)&&void 0!==r?r:n;return s.localeCompare(d)}).filter(e=>!("coinbaseWallet"===e||"com.coinbase.wallet"===e)).map((e,n)=>{let t=ek[e],{name:o,shortName:i,iconConnector:r,icon:a}=t;return(0,I.jsxs)(ok,{onClick:()=>l(t),style:{animationDelay:`${50*n}ms`},children:[(0,I.jsx)(ow,{$outline:!0,children:null!=r?r:a}),(0,I.jsx)(oy,{children:null!=i?i:o})]},n)}),(0,I.jsxs)(ok,{onClick:a,$waiting:c,children:[(0,I.jsx)(ow,{style:{background:"var(--ck-body-background-secondary)"},children:c?(0,I.jsx)("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center"},children:(0,I.jsx)("div",{style:{width:"50%"},children:(0,I.jsx)(tw,{})})}):oO}),(0,I.jsx)(oy,{children:o.more})]})]})})}),(null===(n=t.options)||void 0===n?void 0:n.walletConnectCTA)!=="modal"&&(0,I.jsx)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",gap:14,paddingTop:8},children:(0,I.jsx)(o_,{variant:"button",string:r,children:o.copyToClipboard})})]})})},oW=ej(F.E.div)`
  display: flex;
  flex-direction: column;
  gap: 6px;
  position: relative;
...
`,oB=ej(F.E.div)`
  ...
  ${e=>e.$shake&&z.iv`
      animation: ${oT} 220ms ease-out both;
      &:before {
        animation: ${oz} 220ms ease-out 750ms both;
      }
    `}
`,oH=ej(F.E.button)`
  z-index: 5;
...
`,oY=({children:e,message:n,open:t,xOffset:o=0,yOffset:i=0,delay:r})=>{var a;let c=rC(),s=ng();if(null===(a=c.options)||void 0===a?void 0:a.hideTooltips)return(0,I.jsx)(I.Fragment,{children:e});let[d,l]=(0,A.useState)(!1),[p,h]=(0,A.useState)(!1),[u,g]=(0,A.useState)("small"),[x,b]=(0,A.useState)(!1),[m]=(0,A.useState)(c.route),C=(0,A.useRef)(null),[v,f]=(0,H.Z)({debounce:x?0:220,offsetSize:!0,scroll:!0}),k=()=>{let e=!1,n=o+f.left+f.width,t=i+f.top+.5*f.height;return(n>window.innerWidth||n<0||t>window.innerHeight||t<0)&&(e=!0),e};return("undefined"!=typeof window?A.useLayoutEffect:A.useEffect)(()=>{if(!C.current||f.top+f.bottom+f.left+f.right+f.height+f.width===0)return;let e=o+f.left+f.width,n=i+f.top+.5*f.height;x||0===e||0===n||b(!0),C.current.style.left=`${e}px`,C.current.style.top=`${n}px`,g(C.current.offsetHeight<=40?"small":"large"),h(k())},[f,t,d]),(0,A.useEffect)(()=>{c.open||l(!1)},[c.open]),(0,A.useEffect)(()=>{l(!!t)},[t]),(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)(F.E.div,{ref:v,style:void 0===t?{cursor:"help"}:{},onHoverStart:()=>l(!0),onHoverEnd:()=>l(!1),onClick:()=>l(!1),children:e}),(0,I.jsx)(ez,{children:(0,I.jsx)(W.M,{children:m===c.route&&!p&&d&&(0,I.jsx)(eT,{$useTheme:s.theme,$useMode:s.mode,$customTheme:s.customTheme,children:(0,I.jsx)(oZ,{children:(0,I.jsxs)(oG,{role:"tooltip",$size:u,ref:C,initial:"collapsed",animate:x?"open":{},exit:"collapsed",variants:{collapsed:{transformOrigin:"20px 50%",opacity:0,scale:.9,z:.01,y:"-50%",x:20,transition:{duration:.1}},open:{willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:"-50%",x:20,transition:{ease:[.76,0,.24,1],duration:.15,delay:r||.5}}},children:[n,(0,I.jsx)(oV,{$size:u})]})})})})})]})},oP=ej(F.E.div)`
  z-index: 4;
  position: relative;
  overflow: hidden;
  svg {
...
`,o6=({logo:e,smallLogo:n,connecting:t=!0,unavailable:o=!1,countdown:i=!1})=>(0,I.jsxs)(o3,{transition:{duration:.5,ease:[.175,.885,.32,.98]},children:[(0,I.jsx)(o5,{$small:!o&&n,style:o?{borderRadius:0}:void 0,children:e}),(0,I.jsx)(o4,{children:(0,I.jsxs)(W.M,{children:[t&&(0,I.jsx)(o8,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,transition:{duration:i?1:0}},children:(0,I.jsxs)("svg",{"aria-hidden":"true",width:"102",height:"102",viewBox:"0 0 102 102",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)("path",{d:"M52 100C24.3858 100 2 77.6142 2 50",stroke:"url(#paint0_linear_1943_4139)",strokeWidth:"3.5",strokeLinecap:"round",strokeLinejoin:"round"}),(0,I.jsx)("defs",{children:(0,I.jsxs)("linearGradient",{id:"paint0_linear_1943_4139",x1:"2",y1:"48.5",x2:"53",y2:"100",gradientUnits:"userSpaceOnUse",children:[(0,I.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,I.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]})},"Spinner"),i&&(0,I.jsxs)(o9,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.25},children:[(0,I.jsx)("div",{}),(0,I.jsx)("div",{})]},"ExpiringSpinner")]})})]}),o7={CONNECTED:"connected",CONNECTING:"connecting",EXPIRING:"expiring",FAILED:"failed",REJECTED:"rejected",NOTCONNECTED:"notconnected",UNAVAILABLE:"unavailable"},ie={initial:{willChange:"transform,opacity",position:"relative",opacity:0,scale:.95},animate:{position:"relative",opacity:1,scale:1,transition:{ease:[.16,1,.3,1],duration:.4,delay:.05,position:{delay:0}}},exit:{position:"absolute",opacity:0,scale:.95,transition:{ease:[.16,1,.3,1],duration:.3}}},it=({switchConnectMethod:e,forceState:n})=>{var t,o,i,r,a,c,s,d;let l;let{connect:p}=ot({mutation:{onMutate:e=>{e.connector?w(o7.CONNECTING):w(o7.UNAVAILABLE)},onError(e){console.error(e)},onSettled(e,n){if(n){if(m(!0),setTimeout(()=>m(!1),3500),n.code)switch(n.code){case -32002:w(o7.NOTCONNECTED);break;case 4001:w(o7.REJECTED);break;default:w(o7.FAILED)}else n.message&&("User rejected request"===n.message?w(o7.REJECTED):w(o7.FAILED))}setTimeout(h,100)}}}),{triggerResize:h,connector:u}=rC(),g=nX(u.id),x={name:null==g?void 0:g.name,shortName:null!==(t=null==g?void 0:g.shortName)&&void 0!==t?t:null==g?void 0:g.name,icon:null!==(o=null==g?void 0:g.iconConnector)&&void 0!==o?o:null==g?void 0:g.icon,iconShape:null!==(i=null==g?void 0:g.iconShape)&&void 0!==i?i:"circle",iconShouldShrink:null==g?void 0:g.iconShouldShrink},[b,m]=(0,A.useState)(!1);(0,A.useState)(9);let C=ep(),v=null===(r=null==g?void 0:g.downloadUrls)||void 0===r?void 0:r[C],f=(null==g?void 0:g.downloadUrls)?{name:Object.keys(null==g?void 0:g.downloadUrls)[0],label:(null===(a=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===a?void 0:a.charAt(0).toUpperCase())+(null===(c=Object.keys(null==g?void 0:g.downloadUrls)[0])||void 0===c?void 0:c.slice(1)),url:null==g?void 0:g.downloadUrls[Object.keys(null==g?void 0:g.downloadUrls)[0]]}:void 0,[k,w]=(0,A.useState)(n||((null==g?void 0:g.isInstalled)?o7.CONNECTING:o7.UNAVAILABLE)),y=nR({CONNECTORNAME:x.name,CONNECTORSHORTNAME:null!==(s=x.shortName)&&void 0!==s?s:x.name,SUGGESTEDEXTENSIONBROWSER:null!==(d=null==f?void 0:f.label)&&void 0!==d?d:"your browser"}),j=async()=>{(null==g?void 0:g.isInstalled)&&(null==g?void 0:g.connector)?p({connector:null==g?void 0:g.connector}):w(o7.UNAVAILABLE)};return((0,A.useEffect)(()=>{if(k!==o7.UNAVAILABLE)return l=setTimeout(j,600),()=>{clearTimeout(l)}},[]),g)?em(null==g?void 0:g.connector.id)?(0,I.jsx)(eY,{children:(0,I.jsxs)(oD,{children:[(0,I.jsx)(eQ,{children:"Invalid State"}),(0,I.jsx)(eJ,{children:(0,I.jsx)(ob,{children:"WalletConnect does not have an injection flow. This state should never happen."})})]})}):(0,I.jsx)(eY,{children:(0,I.jsxs)(oD,{children:[(0,I.jsx)(oR,{children:(0,I.jsxs)(oB,{$shake:k===o7.FAILED||k===o7.REJECTED,$circle:"circle"===x.iconShape,children:[(0,I.jsx)(W.M,{children:(k===o7.FAILED||k===o7.REJECTED)&&(0,I.jsx)(oH,{"aria-label":"Retry",initial:{opacity:0,scale:.8},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.8},whileTap:{scale:.9},transition:{duration:.1},onClick:j,children:(0,I.jsx)(oU,{children:(0,I.jsx)(oY,{open:b&&(k===o7.FAILED||k===o7.REJECTED),message:y.tryAgainQuestion,xOffset:-6,children:(0,I.jsx)(nv,{})})})})}),"circle"===x.iconShape?(0,I.jsx)(o6,{logo:k===o7.UNAVAILABLE?(0,I.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:x.icon}):(0,I.jsx)(I.Fragment,{children:x.icon}),smallLogo:x.iconShouldShrink,connecting:k===o7.CONNECTING,unavailable:k===o7.UNAVAILABLE}):(0,I.jsx)(oq,{logo:k===o7.UNAVAILABLE?(0,I.jsx)("div",{style:{transform:"scale(1.14)",position:"relative",width:"100%"},children:x.icon}):(0,I.jsx)(I.Fragment,{children:x.icon}),connecting:k===o7.CONNECTING})]})}),(0,I.jsx)(eX,{children:(0,I.jsxs)(W.M,{initial:!1,children:[k===o7.FAILED&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:(0,I.jsxs)(eJ,{children:[(0,I.jsxs)(eq,{$error:!0,children:[(0,I.jsx)(nb,{}),y.injectionScreen_failed_h1]}),(0,I.jsx)(eK,{children:y.injectionScreen_failed_p})]})},o7.FAILED),k===o7.REJECTED&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:(0,I.jsxs)(eJ,{style:{paddingBottom:28},children:[(0,I.jsx)(eq,{children:y.injectionScreen_rejected_h1}),(0,I.jsx)(eK,{children:y.injectionScreen_rejected_p})]})},o7.REJECTED),(k===o7.CONNECTING||k===o7.EXPIRING)&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:(0,I.jsxs)(eJ,{style:{paddingBottom:28},children:[(0,I.jsx)(eq,{children:"injected"===g.connector.id?y.injectionScreen_connecting_injected_h1:y.injectionScreen_connecting_h1}),(0,I.jsx)(eK,{children:"injected"===g.connector.id?y.injectionScreen_connecting_injected_p:y.injectionScreen_connecting_p})]})},o7.CONNECTING),k===o7.CONNECTED&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:(0,I.jsxs)(eJ,{children:[(0,I.jsxs)(eq,{$valid:!0,children:[(0,I.jsx)(nC,{})," ",y.injectionScreen_connected_h1]}),(0,I.jsx)(eK,{children:y.injectionScreen_connected_p})]})},o7.CONNECTED),k===o7.NOTCONNECTED&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:(0,I.jsxs)(eJ,{children:[(0,I.jsx)(eq,{children:y.injectionScreen_notconnected_h1}),(0,I.jsx)(eK,{children:y.injectionScreen_notconnected_p})]})},o7.NOTCONNECTED),k===o7.UNAVAILABLE&&(0,I.jsx)(oW,{initial:"initial",animate:"animate",exit:"exit",variants:ie,children:v?(0,I.jsxs)(I.Fragment,{children:[(0,I.jsxs)(eJ,{style:{paddingBottom:18},children:[(0,I.jsx)(eq,{children:y.injectionScreen_install_h1}),(0,I.jsx)(eK,{children:y.injectionScreen_install_p})]}),!g.isInstalled&&v&&(0,I.jsx)(tj,{href:v,icon:(0,I.jsx)(o2,{}),children:y.installTheExtension})]}):(0,I.jsxs)(I.Fragment,{children:[(0,I.jsxs)(eJ,{style:{paddingBottom:12},children:[(0,I.jsx)(eq,{children:y.injectionScreen_unavailable_h1}),(0,I.jsx)(eK,{children:y.injectionScreen_unavailable_p})]}),!g.isInstalled&&f&&(0,I.jsxs)(tj,{href:null==f?void 0:f.url,icon:(0,I.jsx)(o2,{browser:null==f?void 0:f.name}),children:["Install on ",null==f?void 0:f.label]})]})},o7.UNAVAILABLE)]})})]})}):(0,I.jsx)(eY,{children:(0,I.jsxs)(oD,{children:[(0,I.jsx)(eQ,{children:"Invalid State"}),(0,I.jsx)(eJ,{children:(0,I.jsx)(ob,{children:"No connectors match the id given. This state should never happen."})})]})})},io=ej(F.E.div)`
  z-index: 3;
  position: relative;
  overflow: hidden;
  height: 0;
...
`,is=ej(F.E.div)`
  ...
  ${e=>e.$wcLogo?z.iv`
        ...
        `}
`,id=(e,n)=>{let t=Array.prototype.slice.call(Z.create(e,{errorCorrectionLevel:n}).modules.data,0),o=Math.sqrt(t.length);return t.reduce((e,n,t)=>(t%o==0?e.push([n]):e[e.length-1].push(n))&&e,[])};function il({ecl:e="M",size:n=200,uri:t,clearArea:o=!1,image:i,imageBackground:r="transparent"}){let a=o?76:0,c=n-20,s=(0,A.useMemo)(()=>{let n=[],o=id(t,e),s=c/o.length;if([{x:0,y:0},{x:1,y:0},{x:0,y:1}].forEach(({x:e,y:t})=>{let i=(o.length-7)*s*e,r=(o.length-7)*s*t;for(let o=0;o<3;o++)n.push((0,I.jsx)("rect",{fill:o%2!=0?"var(--ck-qr-background, var(--ck-body-background))":"var(--ck-qr-dot-color)",rx:-((o-2)*5)+(0===o?2:3),ry:-((o-2)*5)+(0===o?2:3),width:s*(7-2*o),height:s*(7-2*o),x:i+s*o,y:r+s*o},`${o}-${e}-${t}`))}),i){let e=(o.length-7)*s*1,t=(o.length-7)*s*1;n.push((0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)("rect",{fill:r,rx:12,ry:12,width:7*s,height:7*s,x:e+0*s,y:t+0*s}),(0,I.jsx)("foreignObject",{width:7*s,height:7*s,x:e+0*s,y:t+0*s,children:(0,I.jsx)("div",{style:{borderRadius:12,overflow:"hidden"},children:i})})]}))}let d=Math.floor((a+25)/s),l=o.length/2-d/2,p=o.length/2+d/2-1;return o.forEach((e,t)=>{e.forEach((e,r)=>{o[t][r]&&!(t<7&&r<7||t>o.length-8&&r<7||t<7&&r>o.length-8)&&(i||!(t>l&&t<p&&r>l&&r<p))&&n.push((0,I.jsx)("circle",{cx:t*s+s/2,cy:r*s+s/2,fill:"var(--ck-qr-dot-color)",r:s/3},`circle-${t}-${r}`))})}),n},[e,c,t]);return(0,I.jsxs)("svg",{height:c,width:c,viewBox:`0 0 ${c} ${c}`,style:{width:c,height:c},children:[(0,I.jsx)("rect",{fill:"transparent",height:c,width:c}),s]})}function ip({value:e,image:n,imageBackground:t,imagePosition:o="center",tooltipMessage:i}){let r=function(){let[e,n]=(0,A.useState)({width:0,height:0});return(0,A.useEffect)(()=>{function e(){n({width:window.innerWidth,height:window.innerHeight})}return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)},[]),e}().width>920&&i?(0,I.jsx)(oY,{xOffset:139,yOffset:5,delay:.1,message:i,children:n}):n;return(0,I.jsx)(io,{children:(0,I.jsxs)(ii,{children:[n&&(0,I.jsx)(ic,{children:(0,I.jsx)(is,{$wcLogo:"center"!==o,style:{background:"center"===o?t:void 0},children:r})}),(0,I.jsx)(W.M,{initial:!1,children:e?(0,I.jsx)(F.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:(0,I.jsx)(il,{uri:e,size:288,ecl:"M",clearArea:!!("center"===o&&n)})},e):(0,I.jsxs)(ia,{initial:{opacity:.1},animate:{opacity:.1},exit:{opacity:0,position:"absolute",inset:[0,0]},transition:{duration:.2},children:[(0,I.jsx)("span",{}),(0,I.jsx)("span",{}),(0,I.jsx)("span",{}),(0,I.jsx)("div",{})]})})]})})}ip.displayName="CustomQRCode";let ih=ej(F.E.div)`
  position: relative;
  display: flex;
  align-items: center;
  justify-content: center;
...
`,iS=ej(F.E.div)`
  ...
  &:before {
    ...
    opacity: 0.75;
    background-size: 200% 100%;
    animation: ${ij} 1000ms linear infinite both;
  }
`,iE=ej(F.E.div)`
  ...
  ${e=>{if(e.$seed){let n=Math.ceil(e.$seed.split("").map(e=>e.charCodeAt(0)).reduce((e,n)=>e+n)%100/100*8),t=`0${0===n?1:n}`;return z.iv`
...
`,iG=(0,I.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M2 16.75C2.69036 16.75 3.25 17.3096 3.25 18V19C3.25 26.5939 9.40609 32.75 17 32.75V35.25C8.02537 35.25 0.75 27.9746 0.75 19V18C0.75 17.3096 1.30964 16.75 2 16.75Z",fill:"url(#paint0_linear_1288_18701)"}),(0,I.jsx)("defs",{children:(0,I.jsxs)("linearGradient",{id:"paint0_linear_1288_18701",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,I.jsx)("stop",{stopColor:"var(--ck-spinner-color)"}),(0,I.jsx)("stop",{offset:"1",stopColor:"var(--ck-spinner-color)",stopOpacity:"0"})]})})]}),iV=({variant:e})=>{let{connector:n,chain:t}=(0,d.m)(),{chains:o,isPending:i,switchChain:r,error:a}=(0,l.o)(),[c,s]=(0,A.useState)(void 0),p=nR({}),h=ex(),u=(null==a?void 0:a.code)===4902,g=u||!r,x=e=>{r&&(s(e),r({chainId:e}))},{triggerResize:b}=rC();return(0,I.jsxs)(iW,{style:{marginBottom:void 0!==r?-8:0},children:[(0,I.jsx)(iR,{children:(0,I.jsx)(iB,{children:o.map(o=>{var r;let a={...iF.find(e=>e.id===o.id),...o};return(0,I.jsxs)(iH,{$variant:e,disabled:g||a.id===(null==t?void 0:t.id)||i&&c===a.id,onClick:()=>null==x?void 0:x(a.id),style:{opacity:g&&a.id!==(null==t?void 0:t.id)?.4:void 0},children:[(0,I.jsxs)("span",{style:{display:"flex",alignItems:"center",justifyContent:"flex-start",gap:12,color:a.id===(null==t?void 0:t.id)?"var(--ck-dropdown-active-color, inherit)":"inherit"},children:[(0,I.jsxs)(iz,{children:[(0,I.jsx)(iD,{initial:{opacity:0},animate:{opacity:i&&c===a.id?1:0},transition:{ease:[.76,0,.24,1],duration:.15,delay:.1},children:(0,I.jsx)(F.E.div,{animate:h&&eC(null==n?void 0:n.id)&&i&&c===a.id?{opacity:[1,0],transition:{delay:4,duration:3}}:{opacity:1},children:iG},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)}),(0,I.jsx)(iT,{children:null!==(r=a.logo)&&void 0!==r?r:(0,I.jsx)(iO.UnknownChain,{})})]}),a.name]}),"secondary"!==e&&(0,I.jsx)(iU,{children:(0,I.jsxs)(W.M,{initial:!1,exitBeforeEnter:!0,children:[a.id===(null==t?void 0:t.id)&&(0,I.jsx)(F.E.span,{style:{color:"var(--ck-dropdown-active-color, var(--ck-focus-color))",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4,transition:{duration:.1,delay:0}},transition:{ease:[.76,0,.24,1],duration:.3,delay:.2},children:p.connected},"connectedText"),i&&c===a.id&&(0,I.jsx)(F.E.span,{style:{color:"var(--ck-dropdown-pending-color, inherit)",display:"block",position:"relative"},initial:{opacity:0,x:-4},animate:{opacity:1,x:0},exit:{opacity:0,x:4},transition:{ease:[.76,0,.24,1],duration:.3,delay:.1},children:(0,I.jsx)(F.E.span,{animate:h&&eC(null==n?void 0:n.id)&&{opacity:[1,0],transition:{delay:4,duration:4}},children:p.approveInWallet})},"approveText")]})}),"secondary"===e?(0,I.jsx)(iZ,{initial:!1,animate:{opacity:a.id===(null==t?void 0:t.id)?1:0},transition:{duration:.3,ease:"easeOut"}}):a.id===(null==t?void 0:t.id)&&(0,I.jsx)(iZ,{layoutId:"activeChain",layout:"position",transition:{duration:.3,ease:"easeOut"}})]},`${null==a?void 0:a.id}-${null==a?void 0:a.name}`)})})}),(0,I.jsx)(W.M,{children:u&&(0,I.jsx)(F.E.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{ease:[.76,0,.24,1],duration:.3},onAnimationStart:b,onAnimationComplete:b,children:(0,I.jsx)("div",{style:{paddingTop:10,paddingBottom:8},children:(0,I.jsxs)(ob,{children:[p.warnings_walletSwitchingUnsupported," ",p.warnings_walletSwitchingUnsupportedResolve]})})})})]})},iY=ej(F.E.div)`
  z-index: 2147483647;
  position: fixed;
  inset: 0;
`,iP=ej(F.E.div)`
...
`,iX=ej(F.E.div)`
  ...
  user-select: none;
  color: var(--ck-dropdown-color, var(--ck-tooltip-color));
`,iJ=({children:e,open:n,onClose:t,offsetX:o=0,offsetY:i=8})=>{var r,a,c;let s=rC(),d=ng(),l=nR(),[p,h]=(0,A.useState)({x:0,y:0});nd(n);let u=(0,A.useRef)(null);(0,A.useEffect)(()=>{let e=e=>{var o,i,r;if(n&&("Escape"===e.key&&t(),"ArrowDown"===e.key||"ArrowUp"===e.key)){if(!u.current)return;e.preventDefault();let n=null===(o=u.current)||void 0===o?void 0:o.querySelectorAll(`
            a[href]:not(:disabled),
            button:not(:disabled),
            textarea:not(:disabled),
            input[type="text"]:not(:disabled),
            ...
            input[type="checkbox"]:not(:disabled),
            select:not(:disabled)
          `),t=n[0],a=n[n.length-1];if("ArrowUp"===e.key){if(document.activeElement===t)a.focus();else{let e=null===(i=null==document?void 0:document.activeElement)||void 0===i?void 0:i.previousSibling;for(e||(e=a);e.disabled;)e=e.previousSibling;e.focus()}}else if(document.activeElement===a)t.focus();else{let e=null===(r=null==document?void 0:document.activeElement)||void 0===r?void 0:r.nextSibling;for(e||(e=t);e.disabled;)e=e.nextSibling;e.focus()}}};return document.addEventListener("keydown",e),()=>{document.removeEventListener("keydown",e)}},[n]);let g=(0,A.useRef)(null),x=(0,A.useCallback)(e=>{e&&(g.current=e,C())},[n]),[b,m]=(0,H.Z)({debounce:120,offsetSize:!0,scroll:!0}),C=()=>{if(!g.current||m.top+m.bottom+m.left+m.right+m.height+m.width===0)return;let e=m.left+o,n=m.top+m.height+i;g.current.style.left=`${e}px`,g.current.style.top=`${n}px`};return("undefined"!=typeof window?A.useLayoutEffect:A.useEffect)(C,[g.current,m,n]),(0,A.useEffect)(C,[n,g.current]),(0,A.useEffect)(()=>(C(),window.addEventListener("scroll",t),window.addEventListener("resize",t),()=>{window.removeEventListener("scroll",t),window.removeEventListener("resize",t)}),[]),(0,I.jsxs)(I.Fragment,{children:[(0,I.jsx)("div",{ref:b,children:e}),(0,I.jsx)(W.M,{children:n&&(0,I.jsx)(ez,{children:(0,I.jsx)(eT,{$useTheme:null!==(r=d.theme)&&void 0!==r?r:s.theme,$useMode:null!==(a=d.mode)&&void 0!==a?a:s.mode,$customTheme:null!==(c=d.customTheme)&&void 0!==c?c:s.customTheme,children:(0,I.jsx)(nl,{children:(0,I.jsxs)(iY,{ref:u,children:[(0,I.jsx)(iP,{onClick:t}),(0,I.jsxs)(iQ,{ref:x,style:{left:p.x,top:p.y},initial:"collapsed",animate:"open",exit:"collapsed",variants:{collapsed:{transformOrigin:"0 0",opacity:0,scale:.96,z:.01,y:-4,x:0,transition:{duration:.1}},open:{transformOrigin:"0 0",willChange:"opacity,transform",opacity:1,scale:1,z:.01,y:0,x:0,transition:{ease:[.76,0,.24,1],duration:.15}}},children:[(0,I.jsx)(iX,{children:l.switchNetworks}),(0,I.jsx)(iV,{})]})]})})})})})]})},iq=ej.div`
  --bg: transparent;
  --color: #333;
  ${e=>"string"==typeof e.size?z.iv`
          --width: ${e.size};
          --height: ${e.size};
        `:z.iv`
...
`,i2=(0,I.jsxs)("svg",{"aria-hidden":"true",width:"36",height:"36",viewBox:"0 0 36 36",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M11.3592 30.1654C10.0472 29.4491 8.85718 28.524 7.83713 27.424C6.81708 26.324 5.98425 25.0677 5.36889 23.7054C5.20157 23.335 5.05033 22.9567 4.91578 22.5717C4.51465 21.4237 4.26735 20.2308 4.17794 19.0239C4.16599 18.8626 4.13894 18.7041 4.09809 18.5507C3.85023 17.6197 3.09399 16.8738 2.11531 16.7999C0.975331 16.7138 -0.0310983 17.5702 0.0141657 18.7125C0.0223289 18.9185 0.0340286 19.1243 0.049253 19.3298C0.165374 20.8971 0.486545 22.4464 1.00749 23.9373C1.10424 24.2142 1.20764 24.4884 1.31755 24.7596C2.13617 26.7799 3.31595 28.6371 4.80146 30.239C6.28696 31.841 8.04998 33.1573 10.0029 34.1258C10.2651 34.2558 10.5307 34.3796 10.7995 34.4969C12.247 35.1287 13.7676 35.5656 15.3217 35.7995C15.5255 35.8301 15.7298 35.8573 15.9346 35.881C17.0703 36.0122 18.0001 35.0731 18.0001 33.9299C18.0001 32.9484 17.3133 32.1381 16.4036 31.8208C16.2537 31.7685 16.0977 31.7296 15.9377 31.7056C14.7411 31.5255 13.5702 31.1891 12.4556 30.7026C12.0818 30.5394 11.716 30.3601 11.3592 30.1654Z",fill:"url(#paint0_linear_1288_1870)"}),(0,I.jsx)("defs",{children:(0,I.jsxs)("linearGradient",{id:"paint0_linear_1288_1870",x1:"2",y1:"19.4884",x2:"16.8752",y2:"33.7485",gradientUnits:"userSpaceOnUse",children:[(0,I.jsx)("stop",{stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0.7"}),(0,I.jsx)("stop",{offset:"1",stopColor:"var(--ck-connectbutton-balance-color,currentColor)",stopOpacity:"0"})]})})]}),i3=({id:e,unsupported:n,radius:t="50%",size:o=24})=>{var i;let r=oo(e),a=iF.find(n=>n.id===e);return iL()?(0,I.jsx)(iq,{size:o,radius:t,children:(0,I.jsxs)(W.M,{initial:!1,children:[(null!=n?n:!r)&&(0,I.jsx)(i0,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,I.jsxs)("svg",{width:"13",height:"12",viewBox:"0 0 13 12",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[(0,I.jsx)("path",{d:"M2.61317 11.2501H9.46246C10.6009 11.2501 11.3256 10.3506 11.3256 9.3549C11.3256 9.05145 11.255 8.73244 11.0881 8.43303L7.65903 2.14708C7.659 2.14702 7.65897 2.14696 7.65893 2.1469C7.65889 2.14682 7.65884 2.14673 7.65879 2.14664C7.31045 1.50746 6.6741 1.17871 6.04 1.17871C5.41478 1.17871 4.763 1.50043 4.41518 2.14968L0.993416 8.43476C0.828865 8.72426 0.75 9.04297 0.75 9.3549C0.75 10.3506 1.47471 11.2501 2.61317 11.2501Z",fill:"currentColor",stroke:"var(--ck-body-background, #fff)",strokeWidth:"1.5"}),(0,I.jsx)("path",{d:"M6.03258 7.43916C5.77502 7.43916 5.63096 7.29153 5.62223 7.02311L5.55675 4.96973C5.54802 4.69684 5.74446 4.5 6.02821 4.5C6.3076 4.5 6.51277 4.70131 6.50404 4.9742L6.43856 7.01864C6.42546 7.29153 6.2814 7.43916 6.03258 7.43916ZM6.03258 9.11676C5.7401 9.11676 5.5 8.9065 5.5 8.60677C5.5 8.30704 5.7401 8.09678 6.03258 8.09678C6.32506 8.09678 6.56515 8.30256 6.56515 8.60677C6.56515 8.91097 6.32069 9.11676 6.03258 9.11676Z",fill:"white"})]})}),e?(0,I.jsx)(iK,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:null!==(i=null==a?void 0:a.logo)&&void 0!==i?i:(0,I.jsx)(iO.UnknownChain,{})},`${null==a?void 0:a.id}-${null==a?void 0:a.name}-${e}`):(0,I.jsx)(i1,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.3},children:i2},"loading")]})}):(0,I.jsx)("div",{style:{width:o,height:o}})},i5=ej(F.E.div)``,i4=ej(F.E.button)`
  ...
  ${e=>e.disabled?z.iv`
        ...
        `}
`,i9=({...e})=>(0,I.jsx)("svg",{"aria-hidden":"true",width:"11",height:"6",viewBox:"0 0 11 6",fill:"none",xmlns:"http://www.w3.org/2000/svg",...e,children:(0,I.jsx)("path",{d:"M1.5 1L5.5 5L9.5 1",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})}),i8=()=>{let e=rC(),[n,t]=(0,A.useState)(!1),{chain:o}=(0,d.m)(),{chains:i}=(0,l.o)(),r=nR({CHAIN:null==o?void 0:o.name}),a=ex()||(null==window?void 0:window.innerWidth)<eD.mobileWidth;(0,A.useEffect)(()=>{e.open||t(!1)},[e.open]);let c=i.length<=1;return(0,I.jsx)(I.Fragment,{children:(0,I.jsx)(i5,{children:(0,I.jsx)(iJ,{offsetX:-12,open:!a&&n,onClose:()=>t(!1),children:(0,I.jsxs)(i4,{"aria-label":eb(r.switchNetworks).toString(),disabled:c,onClick:()=>{a?e.setRoute(rx.SWITCHNETWORKS):t(!n)},children:[c?(0,I.jsx)(oY,{message:r.chainNetwork,xOffset:-6,delay:.01,children:(0,I.jsx)(i3,{id:null==o?void 0:o.id})}):(0,I.jsx)(i3,{id:null==o?void 0:o.id}),!c&&(0,I.jsx)(i9,{style:{top:1,left:-3}})]})})})})},i6=({closeModal:e})=>{var n,t,o;let i=rC(),r=ng(),a=nR(),{reset:c}=(0,h.$)(),{disconnect:s}=(0,m.q)(),{address:l,isConnected:p,connector:u,chain:g}=(0,d.m)(),b=iI(),{data:v}=(0,x.F)({chainId:1,address:l,config:b}),{data:f}=(0,C.K)({address:l}),[k,w]=(0,A.useState)(!1);(0,A.useEffect)(()=>{p||i.setOpen(!1)},[p]),(0,A.useEffect)(()=>{if(k)return e?e():i.setOpen(!1),()=>{s(),c()}},[k,s,c]);let y=["web95","rounded","minimal"].includes(null!==(t=null!==(n=r.theme)&&void 0!==n?n:i.theme)&&void 0!==t?t:"")?"....":void 0;return(0,I.jsxs)(eY,{children:[(0,I.jsxs)(eJ,{style:{paddingBottom:22,gap:6},children:[(0,I.jsx)(iC,{children:(0,I.jsxs)(iv,{children:[(0,I.jsx)(ik,{children:(0,I.jsx)(i8,{})}),(0,I.jsx)(iA,{address:l})]})}),(0,I.jsx)(eq,{children:(0,I.jsx)(o_,{string:l,children:null!=v?v:es(l,y)})}),(null===(o=null==i?void 0:i.options)||void 0===o?void 0:o.hideBalance)?null:(0,I.jsx)(eK,{children:(0,I.jsx)(iw,{children:(0,I.jsxs)(W.M,{exitBeforeEnter:!0,initial:!1,children:[f&&(0,I.jsxs)(iy,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:[el(Number(null==f?void 0:f.formatted))," ",null==f?void 0:f.symbol]},`chain-${null==g?void 0:g.id}`),!f&&(0,I.jsx)(iS,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.2},children:"\xa0"})]})})})]}),!ev(null==u?void 0:u.id)&&(0,I.jsx)(tj,{onClick:()=>w(!0),icon:(0,I.jsx)(nm,{}),children:a.disconnect})]})},i7=()=>{let{reset:e}=(0,h.$)(),{disconnect:n}=(0,m.q)(),{connector:t,chain:o}=(0,d.m)(),i=oo(null==o?void 0:o.id),r=nR({});return(0,I.jsx)(eY,{style:{width:278},children:(0,I.jsxs)(eJ,{style:{padding:0,marginTop:-10},children:[!i&&(0,I.jsxs)(eK,{children:[r.warnings_chainUnsupported," ",r.warnings_chainUnsupportedResolve]}),(0,I.jsx)("div",{style:{padding:"6px 8px"},children:(0,I.jsx)(iV,{variant:"secondary"})}),!i&&!ev(null==t?void 0:t.id)&&(0,I.jsxs)("div",{style:{paddingTop:12},children:[(0,I.jsx)(n5,{}),(0,I.jsx)(tj,{icon:(0,I.jsx)(nm,{}),variant:"secondary",onClick:()=>{n(),e()},children:r.disconnect})]})]})})},re=z.F4`
  from{ transform: rotate(0deg); }
  to{   transform: rotate(360deg); }
`,rn=z.F4`
...
`,ra=ej(F.E.div)`
  ...
  &:after {
    ...
    margin-left: -60px;
    transition: inherit;
    animation: ${rn} 10s linear infinite;
    background: linear-gradient(
      90deg,
      var(--border-color),
      var(--border-color) 50%,
  ...
  ${({$connected:e})=>e&&z.iv`
    ...
    `};
`,rc=({showSignOutButton:e,onSignIn:n,onSignOut:t})=>{let o=iL(),i=nR(),{setOpen:r}=rk(),{isSignedIn:a,isReady:c,isLoading:s,isRejected:l,isSuccess:p,isError:h,signIn:u,signOut:g,error:x}=nj({onSignIn:e=>null==n?void 0:n(e),onSignOut:()=>null==t?void 0:t()}),{address:b}=(0,d.m)();return o?e&&a?(0,I.jsx)(tj,{style:{margin:0},onClick:g,icon:(0,I.jsx)(nm,{}),children:i.signOut},"button"):b?(0,I.jsx)(tj,{style:{margin:0},arrow:!a&&!s&&!l,onClick:s||p?void 0:u,disabled:s,waiting:s,icon:l&&(0,I.jsx)(F.E.div,{initial:{rotate:-270},animate:{rotate:0},transition:{duration:1,ease:[.175,.885,.32,.98]},children:(0,I.jsx)(nf,{style:{opacity:.4}})}),children:p?i.signedIn:l?i.tryAgain:s?i.awaitingConfirmation:h?null!=x?x:"Unknown Error":i.signIn},"button"):(0,I.jsx)(tj,{style:{margin:0},onClick:()=>r(!0),arrow:!0,children:i.walletNotConnected},"button"):(0,I.jsx)(tj,{style:{margin:0},disabled:!0},"loading")},rs=({src:e,alt:n,width:t,height:o})=>{let i=(0,A.useRef)(null),[r,a]=(0,A.useState)(!0);return(0,A.useEffect)(()=>{i.current&&i.current.complete&&0!==i.current.naturalHeight||a(!1)},[e]),(0,I.jsx)("div",{style:{width:t,height:o,background:"rgba(0,0,0,0.02)",boxShadow:"inset 0 0 0 1px rgba(0,0,0,0.02)"},children:(0,I.jsx)("img",{ref:i,src:e,alt:n,width:t,height:o,onLoad:()=>a(!0),style:{transition:"opacity 0.2s ease",opacity:r?1:0}})})},rd={duration:.2,ease:[.26,.08,.25,1]},rl={duration:.16,ease:[.26,.08,.25,1]},rp=()=>{var e,n;let t=rC(),{isSignedIn:o,reset:i}=nj(),r=ex(),[a,c]=(0,A.useState)(o?"signedIn":"signedOut"),s=nR({}),l="signedIn"===a?{heading:s.signInWithEthereumScreen_signedIn_heading,h1:s.signInWithEthereumScreen_signedIn_h1,p:s.signInWithEthereumScreen_signedIn_p,button:s.signInWithEthereumScreen_signedIn_button}:{heading:s.signInWithEthereumScreen_signedOut_heading,h1:s.signInWithEthereumScreen_signedOut_h1,p:s.signInWithEthereumScreen_signedOut_p,button:s.signInWithEthereumScreen_signedOut_button};(0,A.useEffect)(()=>{o&&c("signedIn")},[]),(0,A.useEffect)(()=>{o||c("signedOut")},[o]);let{address:p}=(0,d.m)(),h=(()=>{let e={svg:null,default:null};return Array.from(document.getElementsByTagName("link")).forEach(n=>{("icon"===n.getAttribute("rel")||"shortcut icon"===n.getAttribute("rel"))&&n.getAttribute("href")&&("image/svg+xml"===n.getAttribute("type")?e.svg=n.getAttribute("href"):e.default=n.getAttribute("href"))}),e})(),u=null!==(n=null!==(e=P())&&void 0!==e?e:h.svg)&&void 0!==n?n:h.default;return(0,I.jsx)(eY,{style:{width:278},children:(0,I.jsxs)(eJ,{style:{padding:0,marginTop:-10},children:[(0,I.jsx)(rt,{children:(0,I.jsx)(W.M,{exitBeforeEnter:!0,children:(0,I.jsx)(F.E.div,{initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rl,children:(0,I.jsx)(eK,{style:{height:42},children:(0,I.jsx)(nY,{children:l.h1})})},eb(l.h1).toString())})}),(0,I.jsxs)(ra,{$connected:o,children:[(0,I.jsx)("div",{style:{position:"absolute",inset:0},children:(0,I.jsx)(rr,{width:"262",height:"134",viewBox:"0 0 262 134",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,I.jsx)(F.E.rect,{x:"0",y:"0",rx:"12",width:"262",height:"134",strokeDasharray:"3 3",animate:{strokeDashoffset:[0,-6]},transition:{duration:.4,ease:"linear",repeat:1/0}})})}),(0,I.jsx)(F.E.div,{initial:!r&&{opacity:0,x:50,scale:.8},animate:{opacity:1,x:0,scale:1},transition:rd,children:(0,I.jsx)(ro,{children:(0,I.jsx)(iA,{address:p,size:64})})},"avatarImage"),(0,I.jsx)(F.E.div,{initial:!r&&{scale:.6},animate:{scale:1},transition:{...rd},children:(0,I.jsx)(ri,{children:(0,I.jsx)(nC,{})})},"tickIcon"),(0,I.jsx)(F.E.div,{initial:!r&&{opacity:0,x:-40,scale:.8},animate:{opacity:1,x:0,scale:1},transition:{...rd},children:(0,I.jsx)(ro,{children:u?(0,I.jsx)(rs,{src:u,alt:"app"}):(0,I.jsx)(iO.UnknownChain,{})})},"appLogo")]},"status"),(0,I.jsx)(W.M,{exitBeforeEnter:!0,children:(0,I.jsx)(F.E.div,{style:{paddingBottom:r?24:12},initial:!r&&{opacity:0,scale:.94},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.94},transition:rl,children:(0,I.jsx)(eK,{style:{height:42,marginTop:-1,marginBottom:-3},children:(0,I.jsx)(nY,{children:l.p})})},eb(l.p).toString())}),(0,I.jsx)(rc,{showSignOutButton:"signedIn"===a,onSignIn:()=>{setTimeout(()=>{t.setOpen(!1)},1e3)}})]})})},rh={},ru=({mode:e="auto",theme:n="auto",customTheme:t=rh,lang:o="en-US"})=>{var i;let r=rC(),{isConnected:a,chain:c}=(0,d.m)(),s=oo(null==c?void 0:c.id),l=!((null===(i=r.options)||void 0===i?void 0:i.enforceSupportedChains)&&a&&!s),p=l&&r.route!==rx.CONNECTORS&&r.route!==rx.PROFILE,h=l&&r.route!==rx.PROFILE,u={onboarding:(0,I.jsx)(tS,{}),about:(0,I.jsx)(tq,{}),download:(0,I.jsx)(im,{}),connectors:(0,I.jsx)(of,{}),mobileConnectors:(0,I.jsx)(oF,{}),connect:(0,I.jsx)(ib,{}),profile:(0,I.jsx)(i6,{}),switchNetworks:(0,I.jsx)(i7,{}),signInWithEthereum:(0,I.jsx)(rp,{})};function g(){r.setOpen(!1)}return(0,A.useEffect)(()=>{var e;a?(r.route!==rx.PROFILE||r.route!==rx.SIGNINWITHETHEREUM)&&(!r.signInWithEthereum||(null===(e=r.options)||void 0===e?void 0:e.disableSiweRedirect)?g():r.setRoute(rx.SIGNINWITHETHEREUM)):g()},[a]),(0,A.useEffect)(()=>r.setMode(e),[e]),(0,A.useEffect)(()=>r.setTheme(n),[n]),(0,A.useEffect)(()=>r.setCustomTheme(t),[t]),(0,A.useEffect)(()=>r.setLang(o),[o]),(0,A.useEffect)(()=>{let e=Y();if(!e||!r.open)return;let n=document.createElement("meta");return n.setAttribute("property","og:title"),n.setAttribute("content",e),document.head.prepend(n),()=>{document.head.removeChild(n)}},[r.open]),(0,I.jsx)(nu,{theme:n,customTheme:t,mode:e,children:(0,I.jsx)(n2,{open:r.open,pages:u,pageId:r.route,onClose:l?g:void 0,onInfo:h?()=>r.setRoute(rx.ABOUT):void 0,onBack:p?()=>{r.route===rx.SIGNINWITHETHEREUM?r.setRoute(rx.PROFILE):r.route===rx.SWITCHNETWORKS?r.setRoute(rx.PROFILE):r.route===rx.DOWNLOAD?r.setRoute(rx.CONNECT):r.setRoute(rx.CONNECTORS)}:void 0})})},rg=({onConnect:e,onDisconnect:n})=>{(0,v.E)({onConnect:({address:n,connector:t,isReconnected:o})=>{o||null==e||e({address:n,connectorId:null==t?void 0:t.id})},onDisconnect:()=>null==n?void 0:n()})},rx={ONBOARDING:"onboarding",ABOUT:"about",CONNECTORS:"connectors",MOBILECONNECTORS:"mobileConnectors",CONNECT:"connect",DOWNLOAD:"download",PROFILE:"profile",SWITCHNETWORKS:"switchNetworks",SIGNINWITHETHEREUM:"signInWithEthereum"},rb=(0,A.createContext)(null),rm=({children:e,theme:n="auto",mode:t="auto",customTheme:o,options:i,onConnect:r,onDisconnect:a,debugMode:c=!1})=>{var s,l,p,h;if(!A.useContext(f.V))throw Error("ConnectKitProvider must be within a WagmiProvider");if(A.useContext(rb))throw Error("Multiple, nested usages of ConnectKitProvider detected. Please use only one.");rg({onConnect:r,onDisconnect:a});let u=on(),g=nQ("injected"),x=Object.assign({},{language:"en-US",hideBalance:!1,hideTooltips:!1,hideQuestionMarkCTA:!1,hideNoWalletCTA:!1,walletConnectCTA:"link",hideRecentBadge:!1,avoidLayoutShift:!0,embedGoogleFonts:!1,truncateLongENSAddress:!0,walletConnectName:void 0,reducedMotion:!1,disclaimer:null,bufferPolyfill:!0,customAvatar:void 0,initialChainId:null===(s=null==u?void 0:u[0])||void 0===s?void 0:s.id,enforceSupportedChains:!1,ethereumOnboardingUrl:void 0,walletOnboardingUrl:void 0,disableSiweRedirect:!1},i);"undefined"!=typeof window&&x.bufferPolyfill&&(window.Buffer=null!==(l=window.Buffer)&&void 0!==l?l:O.Buffer);let[b,m]=(0,A.useState)(n),[C,v]=(0,A.useState)(t),[k,w]=(0,A.useState)(null!=o?o:{}),[y,j]=(0,A.useState)("en-US"),[S,E]=(0,A.useState)(!1),[N,L]=(0,A.useState)({id:""}),[M,_]=(0,A.useState)(rx.CONNECTORS),[F,W]=(0,A.useState)(""),[T,D]=(0,A.useState)(0);x.embedGoogleFonts&&function(e){var n,t;let o=null!==(n=({web95:"Lato",retro:"Nunito",midnight:"Inter",minimal:"Inter",rounded:"Nunito"})[e])&&void 0!==n?n:null;t=null!=o?o:"",(0,A.useEffect)(()=>{if(!t)return;t=t.replace(/ /g,"+");let e=document.createElement("link");e.href="https://fonts.googleapis.com",e.rel="preconnect";let n=document.createElement("link");n.href="https://fonts.gstatic.com",n.rel="preconnect",n.crossOrigin="true";let o=document.createElement("link");return o.href=`https://fonts.googleapis.com/css2?family=${t}:wght@400;500;600&display=swap`,o.rel="stylesheet",document.head.appendChild(e),document.head.appendChild(n),document.head.appendChild(o),()=>{document.head.removeChild(e),document.head.removeChild(n),document.head.removeChild(o)}},[t])}(n),(0,A.useEffect)(()=>m(n),[n]),(0,A.useEffect)(()=>j(x.language||"en-US"),[x.language]),(0,A.useEffect)(()=>W(null),[M,S]);let{chain:R,isConnected:B}=(0,d.m)(),H=oo(null==R?void 0:R.id);(0,A.useEffect)(()=>{B&&x.enforceSupportedChains&&!H&&(E(!0),_(rx.SWITCHNETWORKS))},[B,H,R,M,S]),(0,A.useEffect)(()=>{J()&&(null==g||g.connect())},[g]);let U=c?console.log:()=>{},Z={theme:b,setTheme:m,mode:C,setMode:v,customTheme:o,setCustomTheme:w,lang:y,setLang:j,open:S,setOpen:E,route:M,setRoute:_,connector:N,setConnector:L,signInWithEthereum:null!==(h=null===(p=A.useContext(ny))||void 0===p?void 0:p.enabled)&&void 0!==h&&h,onConnect:r,options:x,errorMessage:F,debugMode:c,log:U,displayError:(e,n)=>{W(e),console.log("---------CONNECTKIT DEBUG---------"),console.log(e),n&&console.table(n),console.log("---------/CONNECTKIT DEBUG---------")},resize:T,triggerResize:()=>D(e=>e+1)};return(0,A.createElement)(rb.Provider,{value:Z},(0,I.jsx)(I.Fragment,{children:(0,I.jsx)(or,{enabled:S,children:(0,I.jsxs)(z.f6,{theme:ey,children:[e,(0,I.jsx)(ru,{lang:y,theme:b,mode:t,customTheme:k})]})})}))},rC=()=>{let e=A.useContext(rb);if(!e)throw Error("ConnectKit Hook must be inside a Provider.");return e},rv={disconnected:[rx.CONNECTORS,rx.ABOUT,rx.ONBOARDING,rx.MOBILECONNECTORS,rx.ONBOARDING],connected:[rx.PROFILE,rx.SWITCHNETWORKS,rx.SIGNINWITHETHEREUM]},rf=[...rv.connected,...rv.disconnected],rk=({onConnect:e,onDisconnect:n}={})=>{let t=rC();rg({onConnect:e,onDisconnect:n});let{isConnected:o}=(0,d.m)(),{signIn:i}=nj(),r=()=>{t.setOpen(!1)},a=()=>{t.setOpen(!0)},c=e=>{let n=e;rf.includes(e)?o?rv.connected.includes(e)||(n=rx.PROFILE,t.log(`Route ${e} is not a valid route when connected, navigating to ${n} instead.`)):rv.disconnected.includes(e)||(n=rx.CONNECTORS,t.log(`Route ${e} is not a valid route when disconnected, navigating to ${n} instead.`)):(n=o?rx.PROFILE:rx.CONNECTORS,t.log(`Route ${e} is not a valid route, navigating to ${n} instead.`)),t.setRoute(n),a()};return{open:t.open,setOpen:e=>{e?c(o?rx.PROFILE:rx.CONNECTORS):r()},openAbout:()=>c(rx.ABOUT),openOnboarding:()=>c(rx.ONBOARDING),openProfile:()=>c(rx.PROFILE),openSwitchNetworks:()=>c(rx.SWITCHNETWORKS),openSIWE:e=>{c(rx.SIGNINWITHETHEREUM),e&&i()}}},rw=ej(F.E.div)`
  top: 0;
  bottom: 0;
  left: 0;
  display: inline-flex;
...
`,rN=({children:e,variant:n="primary",autoSize:t=!0,duration:o=.3,style:i})=>{let[r,a]=(0,H.Z)();return(0,I.jsx)(rS,{className:n,initial:!1,animate:t?{width:a.width>10?a.width:"auto"}:void 0,transition:{duration:o,ease:[.25,1,.5,1],delay:.01},style:i,children:(0,I.jsx)("div",{ref:r,style:{whiteSpace:"nowrap",width:"fit-content",position:"relative",padding:"0 12px"},children:e})})},rL=ej(F.E.div)`
  display: flex;
  align-items: center;
  justify-content: center;
  gap: 8px;
...
`,rI=ej.div`
  ...
  span {
    ...
    border-radius: 4px;
    background: currentColor;
    animation: ${rM} 1000ms ease infinite both;
  }
`,rA=({hideIcon:e,hideSymbol:n})=>{let t=iL(),[o,i]=(0,A.useState)(!0),{address:r,chain:a}=(0,d.m)();on();let c=oo(null==a?void 0:a.id),s=(0,R.NL)(),{data:l}=(0,k.O)({watch:!0}),{data:p,queryKey:h}=(0,C.K)({address:r,chainId:null==a?void 0:a.id});(0,A.useEffect)(()=>{(null==l||l)&&s.invalidateQueries({queryKey:h})},[l,h]);let u=iF.find(e=>e.id===(null==a?void 0:a.id)),g=`${t&&(null==p?void 0:p.formatted)!==void 0?`balance-${null==u?void 0:u.id}-${null==p?void 0:p.formatted}`:"balance-loading"}`;return(0,A.useEffect)(()=>{i(!1)},[]),(0,I.jsx)("div",{style:{position:"relative"},children:(0,I.jsx)(W.M,{initial:!1,children:(0,I.jsx)(F.E.div,{initial:(null==p?void 0:p.formatted)!==void 0&&o?{opacity:1}:{opacity:0,position:"absolute",top:0,left:0,bottom:0},animate:{opacity:1,position:"relative"},exit:{opacity:0,position:"absolute",top:0,left:0,bottom:0},transition:{duration:.4,ease:[.25,1,.5,1],delay:.4},children:r&&t&&(null==p?void 0:p.formatted)!==void 0?c?(0,I.jsxs)(rL,{children:[!e&&(0,I.jsx)(i3,{id:null==a?void 0:a.id}),(0,I.jsx)("span",{style:{minWidth:32},children:el(Number(null==p?void 0:p.formatted))}),!n&&` ${null==p?void 0:p.symbol}`]}):(0,I.jsxs)(rL,{children:[!e&&(0,I.jsx)(i3,{id:null==a?void 0:a.id}),(0,I.jsx)("span",{style:{minWidth:32},children:"???"})]}):(0,I.jsxs)(rL,{children:[!e&&(0,I.jsx)(i3,{id:null==a?void 0:a.id}),(0,I.jsx)("span",{style:{minWidth:32},children:(0,I.jsxs)(rI,{children:[(0,I.jsx)("span",{style:{animationDelay:"0ms"}}),(0,I.jsx)("span",{style:{animationDelay:"50ms"}}),(0,I.jsx)("span",{style:{animationDelay:"100ms"}})]})})]})},g)})})},r_={initial:{zIndex:2,opacity:0,x:"-100%"},animate:{opacity:1,x:.1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,opacity:0,x:"-100%",pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rO={initial:{zIndex:2,opacity:0,x:"100%"},animate:{x:.2,opacity:1,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{zIndex:1,x:"100%",opacity:0,pointerEvents:"none",position:"absolute",transition:{duration:.4,ease:[.25,1,.5,1]}}},rF={initial:{opacity:0},animate:{opacity:1,transition:{duration:.3,ease:[.25,1,.5,1]}},exit:{position:"absolute",opacity:0,transition:{duration:.3,ease:[.25,1,.5,1]}}},rW=({children:e})=>{let n=iL(),t=rC(),{open:o,setOpen:i}=rk(),{address:r,isConnected:a,chain:c}=(0,d.m)(),s=oo(null==c?void 0:c.id),l=iI(),{data:p}=(0,x.F)({chainId:1,address:r,config:l});return e&&n?(0,I.jsx)(I.Fragment,{children:e({show:function(){i(!0),t.setRoute(a?rx.PROFILE:rx.CONNECTORS)},hide:function(){i(!1)},chain:c,unsupported:!s,isConnected:!!r,isConnecting:o,address:r,truncatedAddress:r?es(r):void 0,ensName:null==p?void 0:p.toString()})}):null};function rT({label:e,showAvatar:n,separator:t}){var o;let i=nR({}),r=rC(),{isSignedIn:a}=nj(),{address:c,chain:s}=(0,d.m)(),l=oo(null==s?void 0:s.id),p=iI(),{data:h}=(0,x.F)({chainId:1,address:c,config:p}),u=i.connectWallet;return(0,I.jsx)(W.M,{initial:!1,children:c?(0,I.jsxs)(rw,{initial:"initial",animate:"animate",exit:"exit",variants:rO,style:{height:40},children:[n&&(0,I.jsxs)(ry,{children:[(0,I.jsxs)(W.M,{initial:!1,children:[a&&(0,I.jsx)(F.E.div,{style:{zIndex:2,position:"absolute",bottom:0,right:0},initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,I.jsx)(nw,{})}),!l&&(0,I.jsx)(rj,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},children:(0,I.jsx)("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:(0,I.jsx)("path",{d:"M1.68831 13.5H12.0764C13.1026 13.5 13.7647 12.7197 13.7647 11.763C13.7647 11.4781 13.6985 11.1863 13.5462 10.9149L8.34225 1.37526C8.02445 0.791754 7.45505 0.5 6.88566 0.5C6.31627 0.5 5.73364 0.791754 5.42246 1.37526L0.225108 10.9217C0.0728291 11.1863 0 11.4781 0 11.763C0 12.7197 0.662083 13.5 1.68831 13.5ZM6.88566 8.8048C6.49503 8.8048 6.27655 8.5809 6.26331 8.1738L6.16399 5.0595C6.15075 4.64562 6.44869 4.34708 6.87904 4.34708C7.30278 4.34708 7.61396 4.6524 7.60071 5.06628L7.5014 8.16701C7.48154 8.5809 7.26305 8.8048 6.88566 8.8048ZM6.88566 11.3492C6.44207 11.3492 6.07792 11.0303 6.07792 10.5757C6.07792 10.1211 6.44207 9.80219 6.88566 9.80219C7.32926 9.80219 7.69341 10.1143 7.69341 10.5757C7.69341 11.0371 7.32264 11.3492 6.88566 11.3492Z",fill:"currentColor"})})})]}),(0,I.jsx)(iA,{size:24,address:c})]}),(0,I.jsx)("div",{style:{position:"relative",paddingRight:n?1:0},children:(0,I.jsx)(W.M,{initial:!1,children:h?(0,I.jsx)(rw,{initial:"initial",animate:"animate",exit:"exit",variants:rF,style:{position:h?"relative":"absolute"},children:(null===(o=r.options)||void 0===o?void 0:o.truncateLongENSAddress)?ed(h,20):h},"ckEnsName"):(0,I.jsxs)(rw,{initial:"initial",animate:"animate",exit:"exit",variants:rF,style:{position:h?"absolute":"relative"},children:[es(c,t)," "]},"ckTruncatedAddress")})})]},"connectedText"):(0,I.jsx)(rw,{initial:"initial",animate:"animate",exit:"exit",variants:r_,style:{height:40},children:e||u},"connectWalletText")})}function rz({label:e,showBalance:n=!1,showAvatar:t=!0,theme:o,mode:i,customTheme:r,onClick:a}){var c;let s=iL(),l=rC(),{isConnected:p,address:h,chain:u}=(0,d.m)(),g=oo(null==u?void 0:u.id);function x(){l.setOpen(!0),l.setRoute(p?rx.PROFILE:rx.CONNECTORS)}let b=["web95","rounded","minimal"].includes(null!==(c=null!=o?o:l.theme)&&void 0!==c?c:"")?"....":void 0;if(!s)return null;let m=n&&g,C=h&&m;return(0,I.jsx)(eT,{$useTheme:null!=o?o:l.theme,$useMode:null!=i?i:l.mode,$customTheme:null!=r?r:l.customTheme,children:(0,I.jsxs)(rE,{onClick:()=>{a?a(x):x()},children:[m&&(0,I.jsx)(W.M,{initial:!1,children:C&&(0,I.jsx)(F.E.div,{initial:{opacity:0,x:"100%",width:0,marginRight:0},animate:{opacity:1,x:0,width:"auto",marginRight:-24,transition:{duration:.4,ease:[.25,1,.5,1]}},exit:{opacity:0,x:"100%",width:0,marginRight:0,transition:{duration:.4,ease:[.25,1,.5,1]}},children:(0,I.jsx)(rN,{variant:"secondary",theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:{overflow:"hidden"},children:(0,I.jsx)(F.E.div,{style:{paddingRight:24},children:(0,I.jsx)(rA,{hideSymbol:!0})})})},"balance")}),(0,I.jsx)(rN,{theme:null!=o?o:l.theme,mode:null!=i?i:l.mode,customTheme:null!=r?r:l.customTheme,style:m&&n&&h&&("retro"===o||"retro"===l.theme)?{boxShadow:"var(--ck-connectbutton-balance-connectbutton-box-shadow)",borderRadius:"var(--ck-connectbutton-balance-connectbutton-border-radius)",overflow:"hidden"}:{overflow:"hidden"},children:(0,I.jsx)(rT,{separator:b,showAvatar:t,label:e})})]})})}rW.displayName="ConnectKitButton.Custom",rz.Custom=rW;let rD=z.F4`
  0%{ transform:none; }
...
`;ej.div`
  ...
  opacity: 0;
  &.play {
    animation: ${rR} 1300ms 200ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,ej.div`
  z-index: 1;
  position: absolute;
  inset: 0;
  &.shake {
    animation: ${rD} 300ms 100ms cubic-bezier(0.16, 1, 0.6, 1) both;
  }
`,ej.div`
  z-index: 1;
  position: absolute;
